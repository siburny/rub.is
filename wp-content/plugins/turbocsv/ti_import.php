...
class TI_Import extends TI_Obj {
	...
	*/
	...
	static function create_db($p1 = 'ti_import', $p2 = true) {
		return parent::create_db($p1, $p2);
	}

	static function get($id, $p1 = 'ti_import') {
		$result = parent::get('ti_import', $id);
		return $result;
	}

	static function get_list($p1 = 'ti_import') {
		return parent::get_list('ti_import');
	}

	static function delete($id, $p1 = 'ti_import') {
		return parent::delete('ti_import', $id);
	}

	function save($p1 = 'ti_import') {
		return parent::save($p1);
	}
...
class TI_Template extends TI_Obj {
	...
	static function create_db($p1 = 'ti_template', $p2 = true) {
		return parent::create_db('ti_template', false);
	}

	static function get($id, $p1 = 'ti_template') {
		return parent::get('ti_template', $id);
	}

	static function get_list($p1 = 'ti_template') {
		return parent::get_list('ti_template');
	}

	static function delete($id, $p1 = 'ti_template') {
		return parent::delete('ti_template', $id);
	}

	function save($p1 = 'ti_template') {
