...
class USA extends AbstractProvider
{
    ...
    public function initialize(): void
    {
        ...
        $this->addHoliday($this->ashWednesday($this->year, $this->timezone, $this->locale));
        ...
        $this->addHoliday($this->internationalWomensDay($this->year, $this->timezone, $this->locale, Holiday::TYPE_OTHER));
