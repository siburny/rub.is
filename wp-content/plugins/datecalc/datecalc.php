    ...
    if (array_key_exists('age', $atts) && ($atts['age'] == 'yes' || $atts['age'] == '1' || $atts['age'] == 'true')) {
        ...
        if (!array_key_exists('display', $atts)) {
            if ($diff->y > 1) { // YEAR
                ...
                return $diff->d . ' ' . $doPlural($diff->d, 'day') . ' and ' . $diff->h . ' ' . $doPlural($diff->h, 'hour') . $ago;
