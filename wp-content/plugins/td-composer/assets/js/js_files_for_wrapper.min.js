...
function(b){tdcRecycle.$_restoreContent.toggle()}),tdcRecycle.$_restoreContent.on("click",".tdc-snapshot",function(e){d.isUndefined(tdcRecycle._timeout)||clearTimeout(tdcRecycle._timeout);tdcRecycle._timeout=setTimeout(function(a){a=f(a);var c=new tdcJobManager.job,e=a.find(".tdc-snapshot-shortcode"),h=a.find(".tdc-snapshot-header"),l=tdcUtil.b64DecodeUnicode(e.html()),k=JSON.parse(tdcUtil.b64DecodeUnicode(h.html()));tdcNotice.removeAll();tdcRecycle._currentIndex=a.prevAll(".tdc-snapshot").length;
...
(function(f,d,b,e){tdcState={_headerTemplateId:"",_headerTemplateContent:"",_isGlobalTemplate:!1,_isNoHeader:!1,_isHeaderSticky:!1,_isMobileHeaderSticky:!1,_isGlobalFooterTemplate:!1,_isNoFooter:!1,init:function(a,c,b,e,m,h,d,l){tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b&&tdcState.setGlobalTemplate();e&&tdcState.setNoHeader();tdcState.setFooterTemplateId(m);tdcState.setFooterTemplateContent(h);d&&tdcState.setGlobalFooterTemplate();l&&tdcState.setNoFooter()},setHeaderTemplateId:function(a){tdcState._headerTemplateId=
...
f=window.tdcPostSettings.headerTemplateId;d=window.tdcPostSettings.headerTemplateContent;var a=e=!1,c=window.tdcPostSettings.footerTemplateId,m=window.tdcPostSettings.footerTemplateContent,h=!1,l=!1;""===f?(f=window.tdcAdminSettings.headerTemplateId.toString().replace("tdb_template_",""),d=window.tdcAdminSettings.headerTemplateContent,e=!0):"no_header"===f&&(a=!0);if(""!==d){var k=JSON.parse(tdcUtil.b64DecodeUnicode(d));b.isUndefined(k.tdc_is_header_sticky)||!0!==k.tdc_is_header_sticky||tdcState.setHeaderSticky();
b.isUndefined(k.tdc_is_mobile_header_sticky)||!0!==k.tdc_is_mobile_header_sticky||tdcState.setMobileHeaderSticky()}""===c?(c=window.tdcAdminSettings.footerTemplateId.toString().replace("tdb_template_",""),m=window.tdcAdminSettings.footerTemplateContent,h=!0):"no_footer"===c&&(l=!0);tdcState.init(f,d,e,a,c,m,h,l)})(jQuery,Backbone,_);var tdcSavePost;
...
tdc_post_id:tdcLivePanel.$tdcPostId.val()}}).done(function(a,e,h){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&b.isObject(a)&&(b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.has(a,"header_template_id")&&(tdcState.setHeaderTemplateId(a.header_template_id),tdcSidebar.updateHeaderTemplates()),tdcMain.resetContentModified(),new tdcNotice.notice("Header Successfully Saved!",!1,!0)))}).fail(function(a,
b,e){}))},getHeaderTemplateData:function(){var a=tdcState.getHeaderTemplateId(),c="",b={};""!==a&&"no_header"!==a&&(c=tdcUtil.b64EncodeUnicode(JSON.stringify(tdcIFrameData.getHeaderShortcodeFromData())));tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(c);b.tdc_header_template_id=a;b.tdc_header_template_content=c;b.tdc_assoc_header_template=tdcState.isGlobalTemplate()?"":!0;return b},cloudLoadHeaderTemplate:function(a,c,e,h){b.isUndefined(a)||(h={td_magic_token:tdcLivePanel.$token.val(),
tdc_action:"load_header_template",tdc_header_template_content:a,tdc_header_template_title:h},b.isUndefined(e)||(h.tdc_header_template_id=e),f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/load_header_template","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:h}).done(function(e,m,h){"success"===m&&b.isObject(e)&&(b.has(e,"errors")?new tdcNotice.notice(e.errors,!0,!1):b.has(e,"header_template_id")&&
(tdcState.setHeaderTemplateId(e.header_template_id),tdcState.unsetGlobalTemplate()),tdcSidebar.updateHeaderTemplates(),tdcIFrameData.setHeaderTemplate(a,c))}).fail(function(a,c,b){}))},cloudLoadFooterTemplate:function(a,c,e,h){b.isUndefined(a)||(h={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_footer_template",tdc_footer_template_content:a,tdc_footer_template_title:h},b.isUndefined(e)||(h.tdc_footer_template_id=e),f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/load_footer_template",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:h}).done(function(e,m,h){"success"===m&&b.isObject(e)&&(b.has(e,"errors")?new tdcNotice.notice(e.errors,!0,!1):b.has(e,"footer_template_id")&&(tdcState.setFooterTemplateId(e.footer_template_id),tdcState.unsetGlobalFooterTemplate()),tdcSidebar.updateFooterTemplates(),tdcIFrameData.setFooterTemplate(a,c))}).fail(function(a,c,b){}))},getFooterTemplateData:function(){var a=
...
e,h){window.tdcPostSettings.postContent=tdcUtil.b64EncodeUnicode(tdcSavePost.content);f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===e&&b.isObject(a)&&(b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.has(a,"footer_template_id")&&(tdcState.setFooterTemplateId(a.footer_template_id),tdcSidebar.updateFooterTemplates()),tdcMain.resetContentModified(),new tdcNotice.notice("Footer Successfully Saved!",!1,!0)))}).fail(function(a,b,e){}))}}})(jQuery,Backbone,_);
...
a)},_moveDraggedElement:function(){var a=tdcOperationUI.getDraggedElement(),c=tdcOperationUI.getCurrentElementOver(),m=tdcAdminWrapperUI.$placeholder,h="";if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(m)||!m.is(":visible")&&c!==tdcAdminWrapperUI.$recycle)){var d=tdcOperationUI.isSidebarElementDragged(),k=tdcOperationUI.isElementDragged(),g=!1,n=!1,p=!1,q=!1,t=!1,v=!1,u=tdcOperationUI.isElementWithRowDragged(),r=tdcOperationUI.getRowStartValues();if(k){var w=a.closest(".tdc-elements");if(!d&&
(h=tdcIFrameData._getSourceCol(tdcOperationUI.getDraggedElement()),b.isUndefined(h)))return}else(g=tdcOperationUI.isInnerColumnDragged())&&(w=a.closest(".tdc-inner-columns"));!g&&(n=tdcOperationUI.isInnerRowDragged(),p=tdcOperationUI.isTempInnerRowDragged(),n||p)&&(w=a.closest(".tdc-elements"));n||p||(q=tdcOperationUI.isColumnDragged())&&(w=a.closest(".tdc-columns"));!q&&(t=tdcOperationUI.isRowDragged(),v=tdcOperationUI.isTempRowDragged(),t||v)&&(w=a.closest(".tdc-rows"));if(d||k||g||n||p||q||t||
...
wasElementDragged:k,wasInnerColumnDragged:g,wasInnerRowDragged:n,wasTempInnerRowDragged:p,wasColumnDragged:q,wasRowDragged:t,wasTempRowDragged:v,wasElementWithRowDragged:u,rowStartValues:r,draggedBlockUid:A,sourceColParam:h});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(e);tdcOperationUI.setCurrentElementOver(e);tb_remove()},e,"Are you sure you want to delete this element?");return}if(-1===y&&1===z.length||2===z.length&&-1!==y){c="";var B=a.closest(".tdc-inner-column");if(B.length)c=
...
tdcIFrameData.getModel(c).get("childCollection");b.isUndefined(d)||b.map(d.models,function(a,c){c={error:e,getShortcode:""};tdcIFrameData._checkModelData(a,c);b.isUndefined(c.getShortcode)||(w+=c.getShortcode)});d="";d=b.isUndefined(a)||!0!==a?tdcUtil.b64EncodeUnicode(tdcUtil.b64DecodeUnicode(g)+w):tdcUtil.b64EncodeUnicode(w+tdcUtil.b64DecodeUnicode(g));r.data("templateContent",d);r.data("model_id",c)}m.replaceWith(r);r.closest(".tdc-inner-columns").length?r.addClass("tdc-element-inner-column"):r.closest(".tdc-columns").length&&
...
(c.preventDefault(),tdcOperationUI.setCurrentElementOver(e),tdcColumnUI.positionColumnPlaceholder(c)):(tdcMaskUI.setCurrentContainer(e),c=tdcOperationUI.inRow(a),b.isUndefined(c)||c.mouseenter())}).on("fakemouseenterevent",function(c){if(tdcOperationUI.isColumnDragged(a)){var b=a.find(".tdc-elements:first");if(b.length){var e=b.outerHeight(!0);b=b.outerWidth();var d=a.offset(),k=0,g=a.prevAll("."+tdcColumnUI._elementCssClass);g.length&&g.each(function(a,c){k+=parseInt(f(c).find(".tdc-elements:first").width())});
...
positionColumnPlaceholder:function(a,c){var m=tdcAdminWrapperUI.$placeholder,d=0,l=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)d=a.pageX,l=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){d=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;l=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var k={pageX:d,pageY:l};
...
a.find(".tdc-elements:first");if(b.length){var e=b.outerHeight(!0);b=b.outerWidth();var d=a.offset(),k=0,g=a.prevAll("."+tdcInnerColumnUI._elementCssClass);g.length&&g.each(function(a,c){k+=parseInt(f(c).find(".tdc-elements:first").width())});k+=d.left;parseInt(k)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(k+b)&&parseInt(d.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(d.top+e)&&(tdcOperationUI.setCurrentElementOver(a),tdcInnerColumnUI.positionInnerColumnPlaceholder(c))}}}).on("contextmousedown",
function(c){c.preventDefault();c.stopPropagation();tdcContextMenu.setContextMenu(c,a)&&(tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(a),$currentRow:tdcOperationUI.inRow(a),$currentColumn:tdcOperationUI.inColumn(a),$currentInnerRow:tdcOperationUI.inInnerRow(a),$currentInnerColumn:tdcOperationUI.inInnerColumn(a)}),tdcOperationUI.activeElementOver(a))})},positionInnerColumnPlaceholder:function(a,c){var d=tdcAdminWrapperUI.$placeholder,h=0,l=0;if("mousedown"===a.type||"mousemove"===a.type||
"fakemouseenterevent"===a.type)h=a.pageX,l=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){h=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;l=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var k={pageX:h,pageY:l};tdcOperationUI.setCurrentElementOver(e);tdcOperationUI.getDraggedElement().closest(".tdc-inner-columns").find(".tdc-inner-column").each(function(a,
...
b.isUndefined(p)?0:parseInt(p.replace("px",""));if(h>g.left+l/2){h=a.next();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)a.after(d),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+l+p),"margin-left":-24})}else{h=a.prev();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)a.before(d),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+p),"margin-left":-24})}b.isUndefined(c)||
...
(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){d.X=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;d.Y=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var h={pageX:d.X,pageY:d.Y};tdcOperationUI.setCurrentElementOver(e);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",h))});return}var l=tdcOperationUI.getCurrentElementOver();
if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(l))tdcOperationUI.hidePlaceholder();else{var k=tdcOperationUI.getCurrentElementOverOuterHeight();a=tdcOperationUI.getCurrentElementOverOuterWidth();var g=tdcOperationUI.getCurrentElementOverOffset(),n=tdcOperationUI.getCurrentElementOverHeight(),p=!1;"inline-block"===l.css("display")&&(p=!0);p?(k=tdcOperationUI.getCurrentElementOverPosition(),p=parseInt(l.css("margin-top")),d.Y>g.top+n/2?(d=tdcElementUI._checkInnerColumnLastElement(d),
b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)+parseInt(n)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?(g=parseInt(g.left),d.isInnerColumnLastElement&&(l=l.closest(".tdc-element-inner-row"),g=parseInt(l.offset().left)-parseInt(l.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:g,"margin-top":"","margin-left":"",bottom:"0",width:a})):(g=parseInt(k.left),d.isInnerColumnLastElement&&(l=l.closest(".tdc-element-inner-row"),
g=parseInt(l.position().left)+parseInt(l.css("margin-left"))),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:k.top+p+n,left:g,"margin-top":"","margin-left":"",bottom:"",width:a}))):(d=tdcElementUI._checkInnerColumnFirstElement(d),b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?(g=parseInt(g.left)-parseInt(l.css("margin-left")),tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:g,"margin-top":"0",
"margin-left":"",bottom:"",width:a})):(g=parseInt(k.left),tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:k.top+p,left:g,"margin-top":"","margin-left":"",bottom:"",width:a})))):d.Y>g.top+n/2?(d=tdcElementUI._checkInnerColumnLastElement(d),b.isUndefined(d.elementOuterWidth)||(a=d.elementOuterWidth),parseInt(g.top)+parseInt(k)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"",
...
if(h>d.top+g/2){var n=!1;tdcElementUI.isInnerColumnLastElement(k)&&h>d.top+g-tdcElementUI._innerColumnGap&&(n=!0);n?(k=k.closest(".tdc-element-inner-row"),a=k.outerWidth(!0),h=k.next(),h.length||(k.after(c),tdcOperationUI.updateInfoHelper(e))):(h=k.next(),h.length||(k.after(c),tdcOperationUI.updateInfoHelper(e)));parseInt(d.top)+parseInt(g)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"",
"margin-left":"",bottom:0,width:a}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":-50,"margin-left":"",bottom:"",width:a})}else g=!1,tdcElementUI.isInnerColumnFirstElement(k)&&h<d.top+tdcElementUI._innerColumnGap&&(g=!0),g?(k=k.closest(".tdc-element-inner-row"),a=k.outerWidth(!0),h=k.prev(),h.length||(k.before(c),tdcOperationUI.updateInfoHelper(e))):(h=k.prev(),h.length||(k.before(c),tdcOperationUI.updateInfoHelper(e))),parseInt(d.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?
...
tdcMaskUI.$content.hide(),tdcMaskUI.$contentFull.hide();else{a=tdcMaskUI.$currentElement.closest(".tdc-zone").offset();var c=tdcMaskUI.$currentElement.offset(),e=tdcMaskUI.$currentElement.outerWidth(),d=tdcMaskUI.$currentElement.outerWidth(!0),l=tdcMaskUI.$currentElement.outerHeight(),k=tdcMaskUI.$currentElement.outerHeight(!0),g=tdcMaskUI.$currentElement.css("margin-top"),f=tdcMaskUI.$currentElement.css("margin-left");12>Math.abs(a.top-c.top)?tdcMaskUI.$wrapper.addClass("tdc-mask-top"):tdcMaskUI.$wrapper.removeClass("tdc-mask-top");
tdcMaskUI.$wrapper.css({top:c.top,left:c.left,width:e,height:l});tdcMaskUI.$content.css({top:c.top,left:c.left,width:e,height:l});tdcMaskUI.$contentFull.css({top:c.top-parseFloat(g),left:c.left-parseFloat(f),width:d,height:k});tdcMaskUI.$content.removeAttr("class");tdcMaskUI.$wrapper.show();tdcMaskUI.$content.show();tdcMaskUI.$contentFull.show();tdcMaskUI.setHandlers();a=tdcMaskUI.$currentElement.data("model_id");b.isUndefined(a)||(a=tdcIFrameData.getModel(a),c=a.get("attrs"),b.has(c,"custom_title")?
...
tag:"vc_row",type:"closed",level:1,parentModel:c});new tdcIFrameData.TdcLiveView({model:c,el:l[0]});var g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:c});l.data("model_id",c.cid);d.add(c,{at:k});d=new tdcIFrameData.TdcCollection;d.add(g);c.set("childCollection",d);g.set("childCollection",new tdcIFrameData.TdcCollection);c.getShortcodeRender(3,"",!0,a);tdcOperationUI.setDraggedElement(e);tb_remove()}}},[a],"Are you sure you want to clone the current row and all its elements?"),
...
f(this);if(h.data("type")===a){var m=h.data("model_id");if(!b.isUndefined(m)&&(m=tdcIFrameData.getModel(m),!b.isUndefined(m))){var k=m.get("blockUid");if(!b.isUndefined(k)){var g=tdcAdminIFrameUI.getLiveIframe(),n=g.contents().find("#"+k);n.length||(n=g.contents().find('[data-td-block-uid="'+k+'"]'));n.length&&(k={},tdcOperationUI.inRow(n)?tdcOperationUI.inRow(n)?tdcOperationUI.inColumn(n)?tdcOperationUI.inInnerRow(n)?tdcOperationUI.inInnerColumn(n)?(k.$currentZone=tdcOperationUI.inZone(n),k.$currentRow=
...
c,d,h){var m=tdcIFrameData.getFirstModelByZoneType(a);if(!b.isUndefined(m)){var k=m.get("blockUid");tdcIFrameData.removeModel(m,!0,{silent:!0});m=tdcIFrameData._getOriginalContentJSON(c);if(b.isUndefined(m)||""===m)m=[{child:[tdcShortcodeParser.parse(0,'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]')[0].child[0]],index:0,content:'[tdc_zone type="'+a+'"][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]',shortcode:{tag:"tdc_zone",type:"closed",attrs:{named:{type:a}},content:"[vc_row][vc_column][/vc_column][/vc_row]"}}];
...
["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(a,c){var m;b.isUndefined(d)||(m=JSON.parse(JSON.stringify(d)));"tdc_header_mobile_sticky"!==a||b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot||(b.isUndefined(m)&&(m={}),m.lateCallback=function(){var a=f(tdcAdminIFrameUI._$liveIframe).contents();tdcIFrameData.init(a,!0);tdcRecycle.clearJsItems();tdcOperationUI.init(a);b.isUndefined(m.indexPath)||tdcSidebarPanel.showShortcodeFromPath(m.indexPath)});
tdcIFrameData.rebuildZone(a,"[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]",e,m)});else{var m=JSON.parse(tdcUtil.b64DecodeUnicode(a));tdcIFrameData.iframeContents.find(".tdc-header-wrap").addClass("tdc-zone-invisible");tdcIFrameData.iframeContents.find(".td-header-desktop-wrap, .td-header-desktop-sticky-wrap, .td-header-mobile-wrap, .td-header-mobile-sticky-wrap").removeClass("tdc-zone-invisible");tdcSidebar.$_headerTemplateZones.show();tdcSidebar.$_sidebar.find(".tdu-save-header-template").show();
"Newspaper"===window.tdcAdminSettings.themeName&&["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(a,e){if(m.hasOwnProperty(a)){if(!b.isUndefined(d))var h=JSON.parse(JSON.stringify(d));"tdc_header_mobile_sticky"!==a||b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot||(b.isUndefined(h)&&(h={}),h.lateCallback=function(){var a=f(tdcAdminIFrameUI._$liveIframe).contents();tdcIFrameData.init(a,!0);tdcRecycle.clearJsItems();tdcOperationUI.init(a);
b.has(d,"data")&&b.has(data,"replyJsForEval")&&tdcAdminIFrameUI.evalInIframe(d.data.replyJsForEval);b.isUndefined(h.indexPath)||tdcSidebarPanel.showShortcodeFromPath(h.indexPath)});tdcIFrameData.rebuildZone(a,m[a],c,h)}});"header"===window.tdcPostSettings.tdbTemplateType&&tdcSavePost.updateHeaderTemplate()}},setFooterTemplate:function(a,c,d){if(""===a)if(tdcState.isNoFooter()?tdcIFrameData.iframeContents.find(".tdc-footer-wrap").addClass("tdc-zone-invisible"):tdcIFrameData.iframeContents.find(".tdc-footer-wrap").removeClass("tdc-zone-invisible"),
tdcIFrameData.iframeContents.find(".td-footer-wrap").addClass("tdc-zone-invisible"),tdcSidebar.$_sidebar.find(".tdu-save-footer-template").hide(),b.isUndefined(d)||b.isUndefined(d.is_snapshot)||!d.is_snapshot)tdcRecycle.init(),tdcRecycle.takeSnapshot();else{if("Newspaper"===window.tdcAdminSettings.themeName){if(!b.isUndefined(d))var m=JSON.parse(JSON.stringify(d));tdcIFrameData.rebuildZone("tdc_footer","[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]",e,m)}}else tdcIFrameData.iframeContents.find(".tdc-footer-wrap").addClass("tdc-zone-invisible"),
tdcIFrameData.iframeContents.find(".td-footer-wrap").removeClass("tdc-zone-invisible"),tdcSidebar.$_sidebar.find(".tdu-save-footer-template").show(),"Newspaper"===window.tdcAdminSettings.themeName&&(b.isUndefined(d)||(m=JSON.parse(JSON.stringify(d))),tdcIFrameData.rebuildZone("tdc_footer",a,c,m)),"footer"===window.tdcPostSettings.tdbTemplateType&&tdcSavePost.updateFooterTemplate()},_callbackShortcodeRender:function(a){b.isUndefined(a)||b.isUndefined(a.lateCallback)||(b.isUndefined(a.lateCallbackContext)?
setTimeout(function(){a.lateCallback.call(this)},2E3):setTimeout(function(){a.lateCallback.call(a.lateCallbackContext)},2E3))},_defineStructuredData:function(){tdcIFrameData._isInitialized||(tdcIFrameData.TdcModel=Backbone.Model.extend({getShortcodeRender:function(a,c,d,h,l){var m=this,g={error:e,getShortcode:""};b.isUndefined(h)?tdcIFrameData._checkModelData(m,g):tdcIFrameData._checkModelData(h,g);if(!b.isUndefined(g.getShortcode)){var f=new tdcJobManager.job;f.shortcode=g.getShortcode;f.columns=
a;f.blockUid=c;f.tries=0;f.success_callback=function(a){tdcDebug.log(a);var k=tdcAdminIFrameUI.getIframeWindow();b.isUndefined(h)&&tdcIFrameData.deleteCallback(m);!1===d?m.set("blockUid",a.blockUid):m.set("blockUid",e);b.has(a,"replyHtml")&&(m.set("bindNewContent",d),m.set("shortcode",f.shortcode),m.set("html",a.replyHtml,l));b.has(a,"replyJsForEval")&&(k.tdcEvalGlobal={oldBlockUid:c},tdcAdminIFrameUI.evalInIframe(a.replyJsForEval));b.isUndefined(l)||b.isUndefined(l.earlyCallback)||(b.isUndefined(l.earlyCallbackContext)?
l.earlyCallback.call(this):l.earlyCallback.call(l.earlyCallbackContext))};b.isUndefined(l)||b.isUndefined(l.is_snapshot)||!0!==l.is_snapshot||(f.is_snapshot=!0);f.error_callback=function(a,c){tdcDebug.log(c);tdcDebug.log(a);f.tries||(f.tries++,tdcJobManager.addJob(f))};a=tdcOperationUI.getDraggedElement();b.isUndefined(a)||a.addClass("tdc-dropped");tdcJobManager.addJob(f)}g={error:e,getShortcode:""};tdcIFrameData._checkModelData(m,g);b.isUndefined(g.error)||tdcDebug.log(g.error);g={error:e,getShortcode:""};
b.isUndefined(m.get("parentModel"))||(tdcIFrameData._checkModelData(m.get("parentModel"),g),b.isUndefined(g.error)||tdcDebug.log(g.error))}}),tdcIFrameData.TdcCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcTopCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcLiveView=Backbone.View.extend({initialize:function(){this.listenTo(this.model,"change:current",this.changeCurrent);this.listenTo(this.model,"change:html",this.customRender);
...
this.model.set("blockUid",m.attr("id"));var p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(4,p,a)&&(k=this.model.get("childCollection"),!b.isUndefined(k)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,k,this.$el,4),!b.isEmpty(g)))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),
...
!0,!1);return}a=tdcIFrameData.getFirstModelByZoneType("tdc_content");b.isUndefined(a)&&new tdcNotice.notice("Errors happened in templateContent during tdc_content zone!",!0,!1);k=a.get("childCollection");b.isUndefined(k)&&new tdcNotice.notice("Errors happened in templateContent during tdc_content childCollection!",!0,!1);k=new tdcIFrameData.TdcCollection;a.set("childCollection",k);g={};b.each(c,function(c,b,e){tdcIFrameData._getData(a,c,g)});b.isEmpty(g)||(tdcDebug.log(g),new tdcNotice.notice("Errors happened in templateContent during tdcIFrameData.changeData() -> _getData()!",
!0,!1));c={error:e,shortcode:e};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice(g,!0,!1));k=a.get("childCollection");if(n.length!==k.length){new tdcNotice.notice("Errors happened in templateContent during() tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}q.$el.find(".tdc-row").each(function(a,c){var e=f(c);e.insertBefore(q.$el);a=k.at(a);new tdcIFrameData.TdcLiveView({model:a,el:c});var d=q.$el.prevAll().length;c=a.get("childCollection");
k.add(a,{at:d});window.addRowWrappers(e);if(!0===tdcIFrameData._initNewContentStructureData(2,p,a)&&!b.isUndefined(c))if(d={},tdcIFrameData.bindViewsModelsWrappers(d,c,e,2),b.isEmpty(d))e.data("model_id",a.cid);else{for(var m in d)tdcDebug.log(d[m]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1)}});a.set("childCollection",k);n=tdcOperationUI.inZone(q.$el);q.$el.remove();tdcIFrameData.removeModel(q.model);tdcZoneUI.init(m);tdcRowUI.init(m);tdcColumnUI.init(m);
tdcInnerRowUI.init(m);tdcInnerColumnUI.init(m);tdcElementUI.init(m);tdcSidebar.setSettings({$currentZone:n,$currentRow:m},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}}else if(this.$el.hasClass("tdc-row-temp")){if(a.has("templateContent")){c=tdcUtil.b64DecodeUnicode(a.get("templateContent"));m=this.$el.find(".tdc-row");k=a.get("childCollection");a.set("type","closed");a.set("content",c);a.unset("shortcode",{silent:!0});a.unset("templateContent",{silent:!0});tdcShortcodeParser.init(tdcIFrameData._shortcodeParserSettingsClone);
l=tdcShortcodeParser.parse(1,c);l.length&&(l=b.clone(l[0].shortcode.attrs.named),a.set("attrs",l));this.$el.removeClass("tdc-row-temp").addClass(m.attr("class"));this.$el.attr("id",m.attr("id"));this.$el.html(m.html());this.model.set("blockUid",m.attr("id"));window.addRowWrappers(this.$el);if(!0===tdcIFrameData._initNewContentStructureData(2,c,a)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,k,this.$el,2),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}tdcRowUI.init(this.$el.parent());tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:this.$el},e,this.model)}else{m=this.$el.find(".tdc-row");k=a.get("childCollection");this.$el.removeClass("tdc-row-temp").addClass(m.attr("class"));this.$el.attr("id",m.attr("id"));this.$el.html(m.html());this.model.set("blockUid",m.attr("id"));window.addRowWrappers(this.$el);g={};tdcIFrameData.bindViewsModelsWrappers(g,
k,this.$el,2);if(!b.isEmpty(g)){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcRowUI.init(this.$el.parent());tdcColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(c),$currentRow:this.$el,$currentColumn:tdcOperationUI.inColumn(c),$currentElement:c},e,this.model)}tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-zone")){m=this.$el.find(".tdc-zone");
k=this.model.get("childCollection");b.isUndefined(k)||k.reset();this.$el.html(m.html());this.$el.attr("class",m.attr("class"));this.$el.attr("id",m.attr("id"));this.model.set("blockUid",m.attr("id"));window.addZoneWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(1,p,this.model)&&!b.isUndefined(k)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,k,this.$el,1),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}tdcRowUI.init(this.$el);tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:this.$el});tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-row")){m=this.$el.find(".tdc-row");k=this.model.get("childCollection");b.isUndefined(k)||k.reset();this.$el.html(m.html());this.$el.attr("class",m.attr("class"));this.$el.attr("id",m.attr("id"));this.model.set("blockUid",m.attr("id"));
window.addRowWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(2,p,this.model)&&!b.isUndefined(k)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,k,this.$el,2),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),
$currentRow:this.$el},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-column")){a.has("templateContent")&&(c=tdcUtil.b64DecodeUnicode(a.get("templateContent")),a.set("type","closed"),a.unset("templateContent",{silent:!0}));m=this.$el.find(".tdc-column");k=this.model.get("childCollection");b.isUndefined(k)||k.reset();m.unwrap();this.$el=m;this.$el.data("model_id",this.model.cid);window.addColumnWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(3,
p,this.model)&&(k=this.model.get("childCollection"),!b.isUndefined(k)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,k,this.$el,3),!b.isEmpty(g)))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcColumnUI.init(this.$el.parent());tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:tdcOperationUI.inRow(this.$el),
$currentColumn:this.$el},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-inner-row")){m=this.$el.find(".tdc-inner-row");k=this.model.get("childCollection");b.isUndefined(k)||k.reset();this.$el.html(m.html());window.addInnerRowWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(3,p,this.model)&&!b.isUndefined(k)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,k,this.$el,3),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);
...
a.set("type","closed"),a.unset("templateContent",{silent:!0}));m=this.$el.find(".tdc-inner-column");k=this.model.get("childCollection");b.isUndefined(k)||k.reset();m.unwrap();this.$el=m;this.$el.data("model_id",this.model.cid);window.addInnerColumnWrappers(this.$el);p=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(5,p,this.model)&&(k=this.model.get("childCollection"),!b.isUndefined(k)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,k,this.$el,5),!b.isEmpty(g)))){for(n in g)tdcDebug.log(g[n]);
new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerColumnUI.init(this.$el.parent());tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el),$currentInnerColumn:this.$el},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc_zone")){m=
this.$el.find(".tdc-row");c=this.model.cid;a=tdcIFrameData.getModel(c);k=a.get("childCollection");m.data("model_id",c);this.model.set("blockUid",m.attr("id"));window.addZoneWrappers(this.$el);if(!b.isUndefined(k)&&(g={},tdcIFrameData.bindViewsModelsWrappers(g,k,m,2),!b.isEmpty(g))){for(n in g)tdcDebug.log(g[n]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcZoneUI.init(this.$el);tdcRowUI.init(this.$el);tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);
tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);this.$el=m;tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:m},e,this.model);tdcIFrameData._callbackShortcodeRender(d)}else if(this.$el.hasClass("tdc-element")){m=this.$el.attr("class");n=[];b.isUndefined(m)||(n=this.$el.attr("class").split(/\s+/));this.$el.html(this.model.get("html"));m=this.$el.find(".td_block_wrap");m.unwrap();this.$el=m;this.$el.data("model_id",this.model.cid);this.model.set("blockUid",
m.data("td-block-uid"));m=e;this.model.has("rebindToPanel")&&!0===this.model.get("rebindToPanel")&&(this.model.set("rebindToPanel",!1,{silent:!0}),m=!0);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(this.$el),$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el),$currentInnerColumn:tdcOperationUI.inInnerColumn(this.$el),$currentElement:this.$el},m,this.model);tdcIFrameData._callbackShortcodeRender(d);
...
attrs:{named:{type:a}},content:"[vc_row][vc_column][/vc_column][/vc_row]"}}]});for(var l in c)if(c.hasOwnProperty(l)&&!tdcIFrameData._initComponentData(l,c[l]))return;return!0}},_initComponentData:function(a,c,d){if(!b.isUndefined(d)&&!1!==d||!tdcIFrameData._isInitialized){if(c.length){var m={};b.each(c,function(c,b,d){tdcIFrameData._getData(e,c,m,e,a)});b.isEmpty(m)||(console.log(c),tdcDebug.log(m),new tdcNotice.notice("Errors happened during _initStructureData() -> _getData()!",!0,!1));c={error:e,
shortcode:e};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice(m,!0,!1))}return!0}},_initNewContentStructureData:function(a,c,d){c=tdcIFrameData._getContentJSON(a,c);if(c.length){var m={};b.each(c,function(c,b,e){tdcIFrameData._getData(d,c,m,a)});b.isEmpty(m)||(tdcDebug.log(m),new tdcNotice.notice(m,!0,!1));c={error:e,shortcode:e};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice("Errors happened during _initNewContentStructureData() -> checkCurrentData()!",
!0,!1))}return!0},_getData:function(a,c,e,d,l){var m;if(b.isUndefined(a))var h=tdcIFrameData.tdcTopCollection;else h=a.get("childCollection"),b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,a.set("childCollection",h));for(var f in tdcIFrameData._shortcodeParserSettingsClone)if(!(!b.isUndefined(d)&&parseInt(d,10)>f||b.isUndefined(c.shortcode))&&b.isObject(c.shortcode)&&b.has(c.shortcode,"tag")&&-1!==b.indexOf(tdcIFrameData._shortcodeParserSettingsClone[f],c.shortcode.tag)){0<parseInt(f,10)&&b.isUndefined(a)&&
(m="Not zones as the first elements!");!b.isUndefined(a)&&parseInt(a.get("level"),10)>=parseInt(f,10)&&(m="Elements does not respect the shortcode levels! ParentModel (cid: "+a.cid+" ) level: "+a.get("level")+" - element level : "+f);!b.isUndefined(a)&&2<parseInt(f,10)-parseInt(a.get("level"),10)&&3!==parseInt(a.get("level"),10)&&5!==parseInt(f,10)&&(m="Elements respect the shortcode levels, but the difference higher than 2 is not allowed here!");b.isUndefined(m)||(e[b.keys(e).length]={element:c,
info:m,parentModel:a});5!==parseInt(f,10)||b.isUndefined(c.shortcode.content)||(d=b.clone(c.shortcode.attrs.named),d.content=c.shortcode.content,c.shortcode.attrs.named=d);f={content:c.content,attrs:c.shortcode.attrs.named,tag:c.shortcode.tag,type:c.shortcode.type,level:parseInt(f,10),parentModel:a,bindNewContent:!1};b.isUndefined(l)||(f.type_zone=l);var p=new tdcIFrameData.TdcModel(f);b.has(c,"child")&&0<c.child.length&&(p.set("childCollection",new tdcIFrameData.TdcCollection),b.each(c.child,function(a,
...
c)});b.isUndefined(c.getShortcode)||c.deepLevel--}if(!b.isUndefined(c.getShortcode)){d=a.get("type");var l=a.get("tag"),k=a.get("attrs"),g="";if("undefined"!==typeof c.images){var f=b.clone(k);b.map(k,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[l].params,function(a,d){if(e===a.param_name)if("attach_image"===a.type)a=k[a.param_name],d=tdcJobManager._getUniqueID(),b.isUndefined(c.images.ids)?(c.images.ids={},c.images.ids[a]=d):b.isUndefined(c.images.ids[a])?c.images.ids[a]=d:d=c.images.ids[a],
f[e]=d;else if("tdc_css"===a.param_name&&""!==k.tdc_css){var m=JSON.parse(window.atob(k.tdc_css));b.map(m,function(a,e){b.map(m[e],function(a,d){if(0===a.trim().indexOf("url")){var h=tdcJobManager._getUniqueID();b.isUndefined(c.images.urls)?(c.images.urls={},c.images.urls[a]=h):b.isUndefined(c.images.urls[a])?c.images.urls[a]=h:h=c.images.urls[a];m[e][d]=h}})});f.tdc_css=window.btoa(JSON.stringify(m))}})});k=f}else"undefined"!==typeof c.newImages&&(f=b.clone(k),b.map(k,function(a,e){b.map(window.tdcAdminSettings.mappedShortcodes[l].params,
function(a,d){if(e===a.param_name)if("attach_image"===a.type){var m=k[a.param_name];a=c.newImages.find(function(a){return m===a.uid.substring(8)});"undefined"!==typeof a&&(f[e]=a.attachment_id)}else if("tdc_css"===a.param_name&&""!==k.tdc_css){var h=JSON.parse(window.atob(k.tdc_css));b.map(h,function(a,e){b.map(h[e],function(a,b){var d=c.newImages.find(function(c){return a===c.uid.substring(8)});"undefined"!==typeof d&&(h[e][b]='url("'+d.url+'")')})});f.tdc_css=window.btoa(JSON.stringify(h))}})}),
k=f,a.set("attrs",k));if("td_block_text_with_title"===l||"vc_column_text"===l||"vc_raw_html"===l||"tdc_woo_shortcodes"===l)if(b.map(k,function(a,c){"content"!==c&&(g+=" "+c+'="'+a+'"')}),b.has(k,"content"))if("vc_raw_html"===l||"tdc_woo_shortcodes"===l)g="["+l+g+"]"+b.unescape(k.content)+"[/"+l+"]";else try{var p=tdcUtil.b64DecodeUnicode(k.content);g="["+l+g+"]"+p+"[/"+l+"]"}catch(q){g="["+l+g+"]"+b.unescape(k.content)+"[/"+l+"]"}else g="["+l+g+"]";else switch(b.map(k,function(a,c){g+=" "+c+'="'+
...
!0,!1);var l=tdcIFrameData._getDestinationCol(a.$refEl);h.has("childCollection")||h.set("childCollection",new tdcIFrameData.TdcCollection);var k=h.get("childCollection");var g={},f=c.data("start-values"),p;"undefined"!==typeof f&&(f=JSON.parse(tdcUtil.b64DecodeUnicode(f)),"undefined"!==typeof f&&(b.isArray(f)&&f.length?(g=f[0],1<f.length&&(p=f)):g=f));f=c.data("shortcodeName");g=new tdcIFrameData.TdcModel({content:"",attrs:g,tag:f,type:"single",level:4,parentModel:h});new tdcIFrameData.TdcLiveView({model:g,
el:c[0]});b.isUndefined(p)||g.set("presetValues",p);tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(g.get("tag")+" : sidebar element added");c.data("model_id",g.cid);k.add(g,{at:d});g.set("parentModel",h);g.getShortcodeRender(l,a.draggedBlockUid,!0)}else if(a.wasTempInnerRowDragged)tdcRecycle.takeSnapshot("Sidebar inner-row added"),h=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]),b.isUndefined(h)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1),l=tdcIFrameData._getDestinationCol(a.$refEl),h.has("childCollection")||h.set("childCollection",new tdcIFrameData.TdcCollection),k=h.get("childCollection"),f=c.data("templateContent"),b.isUndefined(f)?(h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:3,parentModel:h}),new tdcIFrameData.TdcLiveView({model:h,el:c[0]}),g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:4,parentModel:h}),c.data("model_id",h.cid),k.add(h,
{at:d}),c=new tdcIFrameData.TdcCollection,c.add(g),h.set("childCollection",c),c=new tdcIFrameData.TdcCollection,g.set("childCollection",c)):(h=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row_inner",type:"template",level:3,parentModel:h}),new tdcIFrameData.TdcLiveView({model:h,el:c[0]}),c.data("model_id",h.cid),k.add(h,{at:d})),h.getShortcodeRender(l,a.draggedBlockUid,!0);else if(a.wasTempRowDragged){tdcRecycle.takeSnapshot("Sidebar row added");f=c.data("templateContent");h=tdcIFrameData._getDestinationModel(a.$refEl,
[".tdc-zone"]);b.isUndefined(h)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);h.has("childCollection")||h.set("childCollection",new tdcIFrameData.TdcCollection);k=h.get("childCollection");if(b.isUndefined(f)){var q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:h});new tdcIFrameData.TdcLiveView({model:q,el:c[0]});g=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q});
c.data("model_id",q.cid);d=c.prevAll(".tdc-row").length;k.add(q,{at:d});k=new tdcIFrameData.TdcCollection;k.add(g);q.set("childCollection",k);d=new tdcIFrameData.TdcCollection;g.set("childCollection",d);a.wasElementWithRowDragged&&(k={},h={},f=c.data("start-values"),l=c.data("row-start-values"),"undefined"!==typeof l&&(h=JSON.parse(window.atob(l))),q.set({attrs:h}),"undefined"!==typeof f&&(k=JSON.parse(window.atob(f)),b.isArray(k)&&(k=k[0])),f=c.data("shortcodeName"),c=new tdcIFrameData.TdcModel({content:"",
attrs:k,tag:f,type:"single",level:3,parentModel:g}),d.add(c),g=new tdcIFrameData.TdcCollection,c.set("childCollection",g))}else q=new tdcIFrameData.TdcModel({templateContent:f,attrs:{},tag:"vc_row",type:"template",level:1,parentModel:h}),new tdcIFrameData.TdcLiveView({model:q,el:c[0]}),d=c.prevAll(".tdc-row").length,c.data("model_id",q.cid),b.isUndefined(h)||(k.add(q,{at:d}),h.set("childCollection",k),q.set("childCollection",new tdcIFrameData.TdcCollection));q.getShortcodeRender(1,a.draggedBlockUid,
...
tdcRecycle.takeSnapshot(g.get("tag")+" : element recycled");return}tdcRecycle.takeSnapshot(g.get("tag")+" : element moved");p=g.get("parentModel");h=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-inner-column",".tdc-column"]);b.isUndefined(h)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);p.cid===h.cid?(l=p.get("childCollection"),l.remove(g,{silent:!0}),l.add(g,{at:d})):(l=tdcIFrameData._getDestinationCol(a.$refEl),h.has("childCollection")||h.set("childCollection",
new tdcIFrameData.TdcCollection),k=h.get("childCollection"),tdcIFrameData.removeModel(g,!1,{silent:!0}),k.add(g,{at:d}),g.set("parentModel",h),a.sourceColParam!==l&&g.getShortcodeRender(l,a.draggedBlockUid,!0));tdcRecycle.takeSnapshot(g.get("tag")+" : element moved")}else if(a.wasInnerRowDragged){tdcDebug.log("case 2");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("inner row recycled");tdcIFrameData.removeModel(g);tdcRecycle.takeSnapshot("Inner row recycled");
return}tdcRecycle.takeSnapshot("Inner row moved");p=g.get("parentModel");h=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]);b.isUndefined(h)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);if(p.cid===h.cid)l=p.get("childCollection"),l.remove(g,{silent:!0}),l.add(g,{at:d});else{h.has("childCollection")||h.set("childCollection",new tdcIFrameData.TdcCollection);k=h.get("childCollection");tdcIFrameData.removeModel(g,!0,{silent:!0});k.add(g,{at:d});
g.set("parentModel",h);a=p.get("attrs");d=h.get("attrs");if(b.has(a,"width"))switch(a.width){case "1/3":l="13";break;case "2/3":l="23"}if(b.has(d,"width"))switch(d.width){case "1/3":f="13";break;case "2/3":f="23"}b.isUndefined(l)&&(l="11");b.isUndefined(f)&&(f="11");if(l!==f&&(a=g.get("childCollection"),!b.isUndefined(a))){a=tdcIFrameData.getChildCollectionWidths(a);b.isUndefined(a)&&(a="11");d="11";k=1;switch(f){case "11":switch(a){case "11":d="11";break;case "23_13":d="23_13";break;case "13_23":d=
"13_23";break;case "12_12":d="13_13_13";break;case "13_13_13":d="13_13_13"}k=3;break;case "13":switch(a){case "11":d="11";break;case "23_13":d="11";break;case "13_23":d="11";break;case "12_12":d="11";break;case "13_13_13":d="11"}break;case "23":switch(a){case "11":d="12_12";break;case "23_13":d="12_12";break;case "13_23":d="12_12";break;case "12_12":d="12_12";break;case "13_13_13":d="12_12"}k=2}if(a!==d||l!==f)tdcIFrameData.changeInnerRowModel(g,a,d),g.getShortcodeRender(k,null,!0)}a=tdcOperationUI.inZone(c);
d=tdcOperationUI.inRow(c);k=tdcOperationUI.inColumn(c);c=tdcOperationUI.inInnerRow(c);b.isUndefined(a)||b.isUndefined(d)||b.isUndefined(k)||b.isUndefined(c)||tdcSidebar.setSettings({$currentZone:a,$currentRow:d,$currentColumn:k,$currentInnerRow:c},!0)}tdcRecycle.takeSnapshot(g.get("tag")+" : inner row moved")}else if(a.wasInnerColumnDragged||a.wasColumnDragged)tdcDebug.log("case 3"),p=g.get("parentModel"),l=p.get("childCollection"),l.remove(g,{silent:!0}),l.add(g,{at:d}),a.wasColumnDragged?(a=tdcOperationUI.inZone(c),
...
attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),l.add(q,{at:0}),k=new tdcIFrameData.TdcCollection,k.add(g),q.set("childCollection",k),g.set("childCollection",new tdcIFrameData.TdcCollection),q.getShortcodeRender(1,a.draggedBlockUid,!0));return}d=c.prevAll(".tdc-row").length;a=c.closest(".tdc-zone").data("model_id");k=l;p.cid!==a&&(h=tdcIFrameData.getModel(a),k=h.get("childCollection"));l.remove(g,{silent:!0});k.add(g,{at:d});h.set("childCollection",k);g.set("parentModel",h);tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(c)});
...
tdcIFrameData._checkModelData(d,c);if(!b.isUndefined(c.error)){new tdcNotice.notice(c.errors,!0,!1);return}b.isUndefined(c.getShortcode)||(a=c.getShortcode)}if(!b.isEmpty(a))return a},bindViewsModelsWrappers:function(a,c,e,d){if(b.isEmpty(a)&&(b.isUndefined(d)&&(d=0),!b.isUndefined(c))){var m=[];switch(d){case 0:var h=[];e.find(".tdc-zone").each(function(){var a=f(this);a.parents(".menu-item").length||h.push(a)});if(c.models.length!==h.length){a[b.keys(a).length]={collection:c,jqDOMElements:h,info:"Error at zones: "+
c.models.length+"(models) : "+h.length+"(dom)"};return}d++;b.each(h,function(c,b,e){b=f(c);e=b.data("type");e=tdcIFrameData.getFirstModelByZoneType(e);b.data("model_id",e.cid);e.set("blockUid",b.attr("id"));e.set("html",c.innerHTML);new tdcIFrameData.TdcLiveView({model:e,el:c});e.has("childCollection")&&tdcIFrameData.bindViewsModelsWrappers(a,e.get("childCollection"),b,d)});d--;return;case 1:e.find(".tdc-row").each(function(){var a=f(this);a.parents(".menu-item").length||m.push(a)});if(c.models.length!==
m.length){a[b.keys(a).length]={collection:c,jqDOMElements:m,info:"Error at rows: "+c.models.length+"(models) : "+m.length+"(dom)"};return}break;case 2:e.find(".tdc-columns:first").children(".tdc-column").each(function(){var a=f(this);a.parents(".menu-item").length||m.push(a)});if(c.models.length!==m.length){a[b.keys(a).length]={collection:c,jqDOMElements:m,info:"Errors at columns: "+c.models.length+"(models) : "+m.length+"(dom)",level:d};return}break;case 3:e.find(".tdc-elements:first").children(".tdc-element, .tdc-element-inner-row").each(function(){var a=
f(this);a.parents(".menu-item").length||m.push(a)});if(c.models.length!==m.length){a[b.keys(a).length]={collection:c,jqDOMElements:m,info:"Errors at columns elements: "+c.models.length+"(models) : "+m.length+"(dom)",level:d};return}break;case 4:e.find(".tdc-inner-columns:first").children(".tdc-inner-column").each(function(){var a=f(this);a.parents(".menu-item").length||m.push(a)});if(c.models.length!==m.length){a[b.keys(a).length]={collection:c,jqDOMElements:m,info:"Errors at inner columns: "+c.models.length+
"(models) : "+m.length+"(dom)",level:d};return}break;case 5:if(e.find(".tdc-elements:first").children(".tdc-element").each(function(){var a=f(this);a.parents(".menu-item").length||m.push(a)}),c.models.length!==m.length){a[b.keys(a).length]={collection:c,jqDOMElements:m,info:"Errors at elements: "+c.models.length+"(models) : "+m.length+"(dom)",level:d};return}}d++;b.each(m,function(e,m,h){m=c.models[m];h=f(e);h.data("model_id",m.cid);m.set("html",e.innerHTML,{silent:!0});if(5===m.get("level")){var l=
h.data("td-block-uid");if(b.isUndefined(l)){var k=h.find(".td_block_inner, .tdb-block-inner, .td-post-sharing");k.length&&(l=k.attr("id"))}}else 3===m.get("level")?(k=h.find(".tdc-inner-row"),k.length&&(l=k.attr("id"))):1===m.get("level")&&(l=h.attr("id"));m.set("blockUid",l);new tdcIFrameData.TdcLiveView({model:m,el:e});!h.hasClass("tdc-element")&&m.has("childCollection")&&0<b.size(m.get("childCollection"))&&tdcIFrameData.bindViewsModelsWrappers(a,m.get("childCollection"),h,d)});d--}},changeRowModel:function(a,
c,e){var d=a.get("childCollection");if("11"===c&&("23_13"===e||"13_23"===e||"13_13_13"===e)){e=e.split("_");var m=e[0].charAt(0)+"/"+e[0].charAt(1),f=d.at(0),g=f.get("attrs");b.isUndefined(g)?f.set("attrs",{width:m}):(g=b.clone(g),g.width=m,f.set("attrs",g));d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[1].charAt(0)+"/"+e[1].charAt(1)},type:"closed",level:1,parentModel:a}));3===e.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+
...
n.add(a)});3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",f);n.add(a)}),tdcIFrameData.removeModel(a));tdcIFrameData.removeModel(p);tdcIFrameData.changeColumnModel(f,c[0],e)}else if(!("23_13"!==c&&"13_23"!==c&&"13_13_13"!==c||"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)){c=c.split("_");e=e.split("_");m=e[0].charAt(0)+"/"+e[0].charAt(1);var t=e[1].charAt(0)+"/"+e[1].charAt(1);f=d.at(0);g=f.get("attrs");p=d.at(1);var v=
p.get("attrs");q=p.get("childCollection");3===e.length?d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a})):3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&(b.isUndefined(q)&&(q=new tdcIFrameData.TdcCollection,p.set("childCollection",q)),b.each(d.models,function(a,c,b){a.set("parentModel",p);q.add(a)})),tdcIFrameData.removeModel(a));g=b.clone(g);g.width=m;f.set("attrs",g);
c[0]!==e[0]&&tdcIFrameData.changeColumnModel(f,c[0],e[0]);m=b.clone(v);m.width=t;p.set("attrs",m);c[1]!==e[1]&&tdcIFrameData.changeColumnModel(p,c[1],e[1])}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)},changeFluidStructureModel:function(a,c,e){var d=a.get("childCollection"),m=a.get("tag"),f="vc_column";c=c.split("_");var g=e.split("_");if("vc_row"===m||"vc_row_inner"===m){"vc_row_inner"===m&&(f="vc_column_inner");if(g.length>c.length)for(m=0;m<g.length;m++){e="";for(var n=0;n<g[m].length;n++)e+=
g[m].charAt(n)+"/";""!==e&&(e=e.substring(0,e.length-1));if(m<c.length){var p=d.at(m);n=p.get("attrs");var q=b.clone(n);q.width=e;p.set("attrs",q)}else d.add(new tdcIFrameData.TdcModel({content:"",tag:f,attrs:{width:e},type:"closed",level:1,parentModel:a}))}else for(m=0;m<c.length;m++)if(m<g.length){p=d.at(m);n=p.get("attrs");q=b.clone(n);e="";for(n=0;n<g[m].length;n++)e+=g[m].charAt(n)+"/";""!==e&&(e=e.substring(0,e.length-1));q.width=e;p.set("attrs",q);var t=p}else{p=d.at(g.length);a=p.get("childCollection");
...
function(d,m,h){if("vc_row_inner"===d.get("tag")&&(d=d.get("childCollection"),!b.isUndefined(d)&&d.length)){var l="";b.each(d.models,function(a,c,e){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(l=c===e.length-1?l+a.width:l+(a.width+"_"))});l=l.replace(/\//g,"");"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l&&(l="");if("11"===c)if("23"===e)if("23_13"===l){var f=d.at(0),g=d.at(1);h=f.get("attrs");m=g.get("attrs");h=b.clone(h);m=b.clone(m);h.width="1/2";m.width="1/2";
f.set("attrs",h);g.set("attrs",m)}else if("13_23"===l)f=d.at(0),g=d.at(1),h=f.get("attrs"),m=g.get("attrs"),h=b.clone(h),m=b.clone(m),h.width="1/2",m.width="1/2",f.set("attrs",h),g.set("attrs",m);else if("13_13_13"===l){f=d.at(0);g=d.at(1);d=d.at(2);h=f.get("attrs");m=g.get("attrs");var k=d.get("attrs");h=b.clone(h);m=b.clone(m);b.clone(k);h.width="1/2";m.width="1/2";f.set("attrs",h);g.set("attrs",m);m=d.get("childCollection");if(!b.isUndefined(m)&&m.length){var n=g.get("childCollection");b.isUndefined(n)&&
(n=new tdcIFrameData.TdcCollection,g.set("childCollection",n));b.each(m.models,function(a,c,b){n.add(a);a.set("parentModel",g)})}tdcIFrameData.removeModel(d)}else{if(d.models.length){f=d.at(0);h=f.get("attrs");h=b.clone(h);var r=f.get("childCollection");delete h.width;f.set("attrs",h);b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r));var w=0;for(b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",
f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}}else{if("13"===e&&d.models.length)for(f=d.at(0),h=f.get("attrs"),h=b.clone(h),r=f.get("childCollection"),delete h.width,f.set("attrs",h),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("23"===
c)if("11"===e)if("12_12"===l)f=d.at(0),g=d.at(1),h=f.get("attrs"),m=g.get("attrs"),h=b.clone(h),m=b.clone(m),h.width="1/3",m.width="1/3",f.set("attrs",h),g.set("attrs",m),m=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),d.add(m);else{if(d.models.length)for(f=d.at(0),h=f.get("attrs"),h=b.clone(h),r=f.get("childCollection"),delete h.width,f.set("attrs",h),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",
...
b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("13"===c)if("11"===e)if(""===l||"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l){if(d.models.length)for(f=d.at(0),h=f.get("attrs"),h=b.clone(h),r=f.get("childCollection"),delete h.width,f.set("attrs",h),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||
b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else"12_12"===l&&d.models.length&&(f=d.at(0),g=d.at(1),h=f.get("attrs"),m=g.get("attrs"),h.width="1/3",m.width="1/3",f.set("attrs",h),g.set("attrs",m),d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===e&&(""===l||"12_12"!==l)&&d.models.length)for(f=d.at(0),h=f.get("attrs"),h=b.clone(h),r=f.get("childCollection"),
delete h.width,f.set("attrs",h),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}})}}},changeInnerRowModel:function(a,c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(e))){var d=a.get("childCollection");if("11"!==c||"12_12"!==e&&"23_13"!==e&&"13_23"!==
e&&"13_13_13"!==e)if("12_12"!==c&&"23_13"!==c&&"13_23"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)"13_13_13"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e?tdcIFrameData.changeFluidStructureModel(a,c,e):("11"===e?(q=d.at(0),t=q.get("attrs"),m=q.get("childCollection"),g=d.at(1),f=g.get("childCollection"),a=d.at(2),d=a.get("childCollection"),b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t)),b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,q.set("childCollection",
...
e),b.isUndefined(f)&&(f=new tdcIFrameData.TdcCollection,g.set("childCollection",f)),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",g);f.add(a)})),tdcIFrameData.removeModel(a));else if("11"===e){q=d.at(0);t=q.get("attrs");var m=q.get("childCollection");g=d.at(1);var f=g.get("childCollection");b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t));b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,q.set("childCollection",m));!b.isUndefined(f)&&f.length&&
...
"all"),"undefined"!==typeof d&&(b.val(""),h.addClass("tdc-css-inherited"),h.find(".tdc-inherit-select").show())):(b.val(d),h.removeClass("tdc-css-inherited"),h.find(".tdc-inherit-select").show()),h.find(".tdc-inherit-select").show());tdcSidebarController.onUpdate(a,c,this.oldValue,e)}});d.on("keyup focus paste cut",".tdc-tab-no-design .tdc-property-textfield input",function(b){if("focusin"===b.type||this.oldValue===this.value)this.oldValue=this.value;else{var e=jQuery(this).val(),a=tdcIFrameData.getModel(jQuery(this).data("model_id"));
...
h.oldValue!==b&&(tdcSidebarController.onUpdate(a,jQuery(h).data("param_name"),h.oldValue,_.escape(b)),h.oldValue=b)});d.on("keyup focus change input",".tdc-tab-no-design .tdc-property-range_multiple input",function(b){var e=jQuery(this),a=this;if("range"===e.attr("type")){var c=e.closest(".tdc-property").find('input[type="radio"]:checked');e.closest(".tdc-property").find('input[type="text"]').val(e.val());c.data("last_value",e.val())}else if("text"===e.attr("type")){a=e.closest(".tdc-property").find('input[type="range"]');
c=e.closest(".tdc-property").find('input[type="radio"]:checked');var d=c.data("default_value"),h=e.val().trim();""!==h||_.isUndefined(d)||""===d||(h=d,e.val(h));a.val(h);c.data("last_value",h);a=a.get(0)}else if("radio"===e.attr("type")){a=e.closest(".tdc-property").find('input[type="range"]');c=e.closest(".tdc-property").find('input[type="text"]');e.closest(".tdc-property").find('input[type="radio"]:checked');h=e.data("last_value");d=e.data("default_value");var f=e.data("unit");e=a.data("min_"+f);
var k=a.data("max_"+f);f=a.data("step_"+f);a.get(0).min=e;a.get(0).max=k;a.get(0).step=f;""===h?(c.val(d),a.val(d)):(c.val(h),a.val(h));a=a.get(0)}d="";c=jQuery(a).parent().find('input[type="radio"]:checked');c.length&&(d=jQuery(c[0]).data("unit_value"));"focusin"===b.type?a.oldValue=a.value+d:(b=a.value+d,d=tdcIFrameData.getModel(jQuery(a).data("model_id")),tdcSidebarController.onUpdate(d,jQuery(a).data("param_name"),a.oldValue,_.escape(b)),a.oldValue=b)});d.on("keyup change input",".tdc-tab-no-design .tdc-property-range_multiple-responsive input",
function(b){var e=jQuery(this),a=e.closest(".tdc-property-responsive"),c=a.find('input[type="range"]'),d=a.find('input[type="radio"]:checked'),h=a.find('input[type="text"]'),f=c.get(0),k="",g=d.data("default_value"),n=tdcIFrameData.getModel(c.data("model_id")),p=c.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[n.attributes.tag],t=n="";var v=[];for(var u=0;u<q.params.length;u++)if(p===q.params[u].param_name){u=q.params[u].tdc_values;for(var r in u)u.hasOwnProperty(r)&&(v.push(u[r].unit),
""===n||""===t)&&(n=u[r].value,t=u[r].unit);break}d.length&&(k=d.data("unit_value"));if("range"===e.attr("type"))v=c.val(),h.val(v),d.data("last_value",v),h.val(v),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+k,tdcSidebar.currentViewportSettings.name)),a.removeClass("tdc-css-inherited");else if("text"===e.attr("type")){if("input"===b.type||"change"===b.type)return;a.removeClass("tdc-css-inherited");v=h.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
v||_.isUndefined(g)||""===g?(c.val(v),d.data("last_value",v),c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+k,tdcSidebar.currentViewportSettings.name))):(c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),c.data("range_value",n),c.data("range_unit",t),c.val(n),k=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=k.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),k.prop("checked",
!0),f.min=r,f.max=d,f.step=q,f.value=n,k.data("last_value",n),h.val(n));else if(""===v)if(k=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),"undefined"===typeof k)c.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),c.data("range_value",n),c.data("range_unit",t),c.val(n),k=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=k.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+q),k.prop("checked",
!0),f.min=r,f.max=d,f.step=q,f.value=n,k.data("last_value",n),h.val(n),a.addClass("tdc-css-inherited");else for(u=0;u<q.params.length;u++){if(p===q.params[u].param_name){v=[];h=[];u=q.params[u].tdc_values;for(r in u)u.hasOwnProperty(r)&&v.push(u[r].unit);for(u=0;u<v.length&&!(h=k.split(v[u]),1<h.length);u++);h.length&&(n=h[0],t=v[u],c.data("range_value",n),c.data("range_unit",t),k=a.find('input[type="radio"][data-unit_value="'+t+'"]'),q=k.data("unit"),r=c.data("min_"+q),d=c.data("max_"+q),q=c.data("step_"+
...
p=d.data("last_value");q=d.data("unit");r=c.data("min_"+q);d=c.data("max_"+q);q=c.data("step_"+q);f.min=r;f.max=d;f.step=q;""===p?(h.val(g),c.val(g),v=g):(h.val(p),c.val(p),v=p);c.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(c.attr("name"),v+k,tdcSidebar.currentViewportSettings.name));a.removeClass("tdc-css-inherited")}k="";a=jQuery(f).parent().find('input[type="radio"]:checked');a.length&&(k=jQuery(a[0]).data("unit_value"));"focusin"===b.type?f.oldValue=f.value+k:(a=jQuery(f),
...
d)});d.on("click",".tdc-colorpicker-wrap",function(b){tdcSidebarPanel.showHideTdcPalette.call(this,b)});d.on("mousedown",function(b){var d=jQuery("#tdc-sidebar"),a=jQuery("#tdc-icon-selector"),c=jQuery("#tdc-gradient"),m=jQuery("#tdc-palette"),h=jQuery("#tdc-font-list"),f=jQuery(".tdc-preset-values-list");a.length?a.get(0).contains(b.target)||(a.hide(),d.after(a)):a=tdcSidebar.buildIconSelector();c.length?c.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-gradient-wrap")||(c.hide(),
d.after(c))):c=tdcSidebar.buildGradient();m.length?m.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-colorpicker-wrap")||(m.hide(),d.after(m),m.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):m=tdcSidebar.buildPalette();h.length&&!h.get(0).contains(b.target)&&(h.hide(),d.after(h));!f.length||f.get(0).contains(b.target)||jQuery(".tdc-preset-values").get(0).contains(b.target)?f.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(b.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
...
b}});d.on("click",".tdc-tab-no-design .tdc-open-wpeditor",function(b){b.preventDefault();var d=jQuery(this);b=jQuery("#tdc-wpeditor");var a=b.children(".content"),c=d.data("mapped_parameter_name");d=d.data("model_id");var m=tdcIFrameData.getModel(d).get("parentModel").get("attrs"),h="tdc-three-column";if(_.has(m,"width"))switch(m.width){case "1/3":h="tdc-one-column";break;case "2/3":h="tdc-two-column"}a.addClass("tdc-dropped-wpeditor");a.html('<iframe id="tdc-iframe-wpeditor" class="'+h+'" src="'+
...
b.name+'</span><span class="tdc-font-delete"></span></div>').appendTo(f)}));if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(f);b=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var h=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<h;h--){var l=window.tdcAdminSettings.tdcSavings.recentFonts[h],k=b[l];_.isUndefined(k)||jQuery('<div class="tdc-recent-font-settings" data-value="'+
l+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+k+'</span><span class="tdc-recent-font-delete"></span></div>').appendTo(f)}}d.after(f);f.toggle()}});d.on("click",".tdc-font-delete",function(b){b.stopImmediatePropagation();var d=jQuery(this).closest(".tdc-font-settings");b=d.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:b});window.tdcAdminSettings.tdcSavings.fonts.splice(b,1);tdcUtil.updateTdcSavings(this,function(){d.remove()})});d.on("click",
...
f=b.data("param_name").replace("font_settings",""),h="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" ");_.each(d,function(a,b,d){-1!==_.indexOf(h,b)&&(c[f+b]=a)});a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)});d.on("click",".tdc-recent-font-settings",function(){var b=jQuery(this),d=b.data("value"),a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs");b=b.data("param_name").replace("font_settings","");c[b+"font_family"]=
...
tdcIFrameData._checkModelData(b,d));var e=b.get("tag");b=b.get("attrs");b=_.clone(b);if(!_.isUndefined(b)){var a={};d={};for(var c in b)0===c.indexOf("tds_")&&(a[c]=b[c]);c=window.tdcAdminSettings.mappedShortcodes[e].params;for(e=0;e<c.length;e++){var m=!1,h=c[e];if(0===h.param_name.indexOf("tds_")){for(var l in a)if(h.param_name===l){d[l]=a[l];m=!0;break}m||(d[h.param_name]="")}}for(l in a)switch(a=l.split("-"),a.length){case 2:if(!_.has(d,l)){c=a[0];a=!1;for(var k in d)if(c===d[k]&&1===k.split("-").length){a=
!0;break}if(!a){var g;for(g in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[g],c)){var n=g;break}_.has(d,n)&&""===d[n]&&window.tdcAdminSettings.globalStyle[n]===c&&(a=!0)}a||delete b[l]}break;case 3:c=a[0];e=a[2];for(g in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[g],c)){n=g;break}a=!1;for(k in d)if(c===d[k]&&k===n+"-"+e){a=!0;break}a||_.has(d,n+"-"+e)&&""===d[n+"-"+e]&&window.tdcAdminSettings.globalStyle[n]===c&&(a=
!0);a||delete b[l]}return b}},getCurrentListAtts:function(d,b,e){_.isUndefined(b)&&(d=jQuery(d.currentTarget).data("model_id"),b=tdcIFrameData.getModel(d),d={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,d));d=b.get("tag");b=b.get("attrs");var a=_.clone(b);if(!_.isUndefined(a)){var c={};b={};for(var m in a)0===m.indexOf("tds_")&&(c[m]=a[m]);m=window.tdcAdminSettings.mappedShortcodes[d].params;for(var h=0;h<m.length;h++){var l=!1,k=m[h];if(0===k.param_name.indexOf("tds_")){for(var g in c)if(k.param_name===
g){b[g]=c[g];l=!0;break}l||(b[k.param_name]="")}}for(g in c)switch(c=g.split("-"),c.length){case 2:if(!_.has(b,g)){m=c[0];c=!1;for(var n in b)if(m===b[n]&&1===n.split("-").length){c=!0;break}if(!c){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],m)){var q=p;break}_.has(b,q)&&""===b[q]&&window.tdcAdminSettings.globalStyle[q]===m&&(c=!0)}c||delete a[g]}break;case 3:m=c[0];l=c[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],
m)){q=p;break}c=!1;for(n in b)if(m===b[n]&&n===q+"-"+l){c=!0;break}c||_.has(b,q+"-"+l)&&""===b[q+"-"+l]&&window.tdcAdminSettings.globalStyle[q]===m&&(c=!0);c||delete a[g]}var t=[],v;for(v in window.tdcAdminSettings.listStyles[e])if(v===d){for(h=0;h<window.tdcAdminSettings.listStyles[e][v].length;h++)g=window.tdcAdminSettings.listStyles[e][v][h],_.isArray(g)?_.map(g,function(c){_.isUndefined(a[c])||(_.isUndefined(t[h])&&(t[h]=[]),t[h].push(a[c]))}):_.isUndefined(a[g])||(_.isArray(a[g])&&a[g].length?
t[h]=a[g][0]:t[h]=a[g]);break}return t}},showHideTdcPalette:function(d){d=jQuery("#tdc-palette");var b=jQuery(this).closest(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.next("#tdc-palette").length?(d.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),b.after(d),d.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var d=jQuery("#tdc-palette"),b=d.prev(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),
...
(c=jQuery("img",d).attr("class"),e=jQuery("img",d).attr("height"),f=jQuery("img",d).attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:c,action:"tdc_ajax_get_image_id"}}).done(function(c,d,h){"success"===d&&(_.isObject(c)&&_.has(c,"errors")?new tdcNotice.notice(c.errors,!0,!1):(b.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),
b.attr("style","background-image: url( '"+a+"') "),b.data("image_link",a),b.data("image_id",c.image_id),b.data("image_height",e),b.data("image_width",f),b.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),d="",h=b.data("model_id"),h=tdcIFrameData.getModel(h),b.hasClass("tdc-no-image-selected")||(d=c.image_id.toString()),c=h.get("attrs"),c.media_size_image_height=e,c.media_size_image_width=f,h.set("attrs",c),tdcSidebarController.onUpdate(h,
b.data("param_name"),"",d)))}).fail(function(a,c,b){})};return!1},tdcImageRemoveHandler:function(d){var b=jQuery(d.currentTarget);d=b.closest(".tdc-property-wrap").find(".tdc-image-wrap");b.addClass("tdc-hidden-button");d.addClass("tdc-no-image-selected");jQuery.removeData(d,"image_link");d.attr("style","background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png'");b=d.data("model_id");b=tdcIFrameData.getModel(b);tdcSidebarController.onUpdate(b,d.data("param_name"),
...
tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=d;for(var e=[],a=0;a<b.params.length;a++){var c=tdcSidebarPanel._defaultGroupName;_.isEmpty(b.params[a].group)||(c=b.params[a].group);e.push(c)}e=_.uniq(e);var f=c="",h=tdcSidebar.getCurrentTabId(),l,k;c+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var g=k=l="";for(a=0;a<e.length;a++){f=tdcSidebarPanel._fixGroupName(e[a]);var n=tdcUtil.makeSafeForCSS(f);0===a?(l='<a href="#" data-tab-id="td-tab-'+
n+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>',k='<a href="#" data-tab-id="td-tab-'+n+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>'):_.isUndefined(h)||h!=="td-tab-"+n?g+='<a href="#" data-tab-id="td-tab-'+n+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>':(l=k,g+='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>')}f=
n=k=a="";switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "landscape":k="selected";break;case "portrait":n="selected";break;case "phone":f="selected"}c=c+(l+g)+'</div><div class="tdc-tab-responsive">';c+='<div class="tdc-responsive-buttons">';c+='<div class="tdc-responsive-all '+a+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>';"Newspaper"===window.tdcAdminSettings.themeName&&(c+='<div class="tdc-responsive-tablet-landscape '+k+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>');
c+='<div class="tdc-responsive-tablet-portrait '+n+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>';c+='<div class="tdc-responsive-phone '+f+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>';c+="</div>";c+="</div>";c+='<div class="tdc-search">';c+='<i class="td-icon-search"></i>';c+='<input type="text" placeholder="Search settings..." />';c+="</div></div>";c+='<div class="tdc-sidebar-sticky-a"></div>';c+='<div class="tdc-sidebar-sticky-b"></div>';
c+='<div class="tdc-tab-content-wrap">';g=k=l="";for(a=0;a<e.length;a++){f=tdcSidebarPanel._fixGroupName(e[a]);n=tdcUtil.makeSafeForCSS(f);f="tdc-tab-no-design";var p=d.get("tag");"css"===n&&(f="tdc-tab-design");0===a?(l='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+n+'">',k='<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">',n=window.tdcAdminSettings.mappedShortcodes[p].tdc_start_values,d.unset("presetValues"),_.isUndefined(n)||(n=JSON.parse(window.atob(n)),_.isArray(n)&&
1<n.length&&d.set("presetValues",n)),d.has("presetValues")&&(n=d.get("presetValues"),g+=tdcSidebarPanel._addPresetValuesSelector(n,d))):_.isUndefined(h)||h!=="td-tab-"+n?g+='<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">':(l=k,g+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+n+'">');g+=tdcSidebarPanel._bindGroupAndGetHtml(e[a],b,d);n=' data-model_id="'+d.cid+'" ';"dev"===window.tdcAdminSettings.deployMode&&(g+='<div class="tdc-sidebar-row-buttons">',g+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+
n+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',g+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+n+' title="Get the current styles\' settings">CONSOLE: style presets</div>',g+="</div>");g+="</div>"}c=c+(l+g)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(c);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues=
{},"all"===tdcSidebar.currentViewportSettings.name?jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"):jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),c=a.find("[data-responsive]"),b=c.attr("name"),d=c.data("responsive");try{var e=window.atob(d);window.tdcResponsiveValues[b]=JSON.parse(e)}catch(w){d={},a.hasClass("tdc-property-textfield-responsive")?""!==c.val()&&(d.all=
c.val()):a.hasClass("tdc-property-dropdown-responsive")?c.find("option:first").val()!==c.val()&&(d.all=c.val()):a.hasClass("tdc-property-checkbox-responsive")?c.is(":checked")&&(d.all=c.val()):a.hasClass("tdc-property-range-responsive")?d.all=c.data("value"):a.hasClass("tdc-property-range_multiple-responsive")&&(d.all=c.data("range_value")+c.data("range_unit")),window.tdcResponsiveValues[b]=d}tdcSidebarPanel.setViewportCurrentResponsiveValue(c)}))});tdcSidebarPanel._hook.addAction("panel_rendered",
function(){jQuery(".tdc-tab-content-wrap").find('select[name$="font_family"]').change(function(a){a=jQuery(this).val();""===window.tdcAdminSettings.tdcSavings&&(window.tdcAdminSettings.tdcSavings={});"undefined"===typeof window.tdcAdminSettings.tdcSavings.recentFonts&&(window.tdcAdminSettings.tdcSavings.recentFonts=[]);var c=window.tdcAdminSettings.tdcSavings.recentFonts.indexOf(a);-1!==c&&window.tdcAdminSettings.tdcSavings.recentFonts.splice(c,1);window.tdcAdminSettings.tdcSavings.recentFonts.push(a);
...
"",c=e.get("attrs");if("tdc_zone"===e.get("tag"))var f=c.type;for(var h=0;h<b.params.length;h++){var l=b.params[h].param_name,k=b.params[h].group;if(d===tdcSidebarPanel._defaultGroupName&&_.isEmpty(b.params[h].group)||b.params[h].group===d){if(!_.isUndefined(f)&&(!_.isUndefined(b.params[h].zone_group)&&f!==b.params[h].zone_group||"type"===l))continue;a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[h],e)}if("block_template_id"===l){k=c.block_template_id;_.isEmpty(k)&&(k=window.tdcAdminSettings.globalBlockTemplate);
l=window.tdcAdminSettings.mappedBlockTemplates;for(var g=0;g<l[k].params.length;g++)if(d===tdcSidebarPanel._defaultGroupName&&_.isEmpty(l[k].params[g].group)||l[k].params[g].group===d)a+=tdcSidebarPanel._bindParamAndGetHtml(l[k].params[g],e)}else if(0===l.indexOf("tds_")){var n=l.split("-");g=n[0];var p;2===n.length?p=n[1]:2<n.length&&new tdcNotice.notice('Param "'+l+'" must have up to at most one "-" separator ',!0,!1);l=c[l];_.isEmpty(l)&&(l=window.tdcAdminSettings.globalStyle[g]);n=window.tdcAdminSettings.settingsStyle[g];
for(g=0;g<n[l].params.length;g++)if(k==d||_.isUndefined(k)&&d===tdcSidebarPanel._defaultGroupName){var q=JSON.parse(JSON.stringify(n[l].params[g]));q.param_name=l+"-"+q.param_name;_.isUndefined(p)||(q.param_name+="-"+p);a+=tdcSidebarPanel._bindParamAndGetHtml(q,e)}}}return a},_bindParamAndGetHtml:function(d,b){switch(d.type){case "custom":return tdcSidebarPanel.addCustom(d,b);case "colorpicker":return tdcSidebarPanel.addColorpicker(d,b);case "gradient":return tdcSidebarPanel.addGradient(d,b);case "dropdown":return tdcSidebarPanel.addDropDown(d,
...
tdcSidebarPanel.callbackColorPicker);return a},addCustom:function(d,b){b="";_.has(d,"description")&&""!==d.description&&(b=' title="'+d.description+'" ');var e='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';e+='<div class="tdc-property-title"><span class="tdc-search-data"'+b+">"+d.heading+"</span></div>";e=e+'<div class="tdc-property">'+d.value;e=e+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return e+"</div>"},callbackColorPicker:function(){jQuery("#tdc-palette-color-picker").tdPalette();
jQuery(".tdc-tab-no-design .tdc-property-colorpicker").each(function(){var d=jQuery(this),b=d.find("input");d=d.find(".tdc-colorpicker-wrap");_.isUndefined(b.val())||""===b.val()||d.attr("style","background: "+b.val())})},addGradient:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=
a+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(d,b)+'"/>');a=a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");a+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackGradient);
return a},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var d=jQuery(this),b=d.find("input");d=d.find(".tdc-gradient-wrap");if(!_.isUndefined(b.val())&&""!==b.val())try{var e=JSON.parse(window.atob(b.val()));_.isUndefined(e.css)||d.attr("style",e.css)}catch(a){e=b.val(),_.isUndefined(e)||d.attr("style","background: "+e)}})},addDropDown:function(d,b){if("tdb_mobile_menu"===b.get("tag")&&"menu_id"===d.param_name){var e=
b.get("attrs");e.menu_id=window.tdcPostSettings.mobileMenuId;b.set("attrs",e)}var a=e=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",h=Object.keys(d.value);if(_.has(d,"tdc_min_options")&&h.length<=parseInt(d.tdc_min_options))return c;for(var l=0;l<h.length;l++){var k=!1,g="",n="",p=h[l],q=String(tdcSidebarPanel._getParameterCurrentValue(d,b)),t=String(d.value[h[l]]);_.isObject(d.value[h[l]])&&(k=
!0,t=_.values(d.value[h[l]])[0],p=_.keys(d.value[h[l]])[0]);if(e||a){0===l&&""===q&&(q=t);q===t&&(g=" checked ");n=_.uniqueId();q=t;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)q="col_"+q;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+n+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+g+' value="'+t+'">';e?(g="",k&&(g="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+g+'" for="'+n+'" title="'+
p+'"><div class="'+q+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+n+'" title="'+p+'">'+t+"</label>"}else q===t&&(g=' selected="selected" '),"__"===t&&-1!==p.search("--")&&(n=" disabled "),f+="<option "+g+" "+n+' value="'+t+'">'+p+"</option>"}h="";_.has(d,"description")&&""!==d.description&&(h=' title="'+d.description+'" ');c+='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+h+">"+d.heading+
"</span></div>";c+='<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'">',c=c+f+"</select>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return c+"</div>"},addDropDownResponsive:function(d,b){var e=!1,a=!1;_.has(d,"tdc_dropdown_images")&&""!==d.tdc_dropdown_images&&(e=!0);_.has(d,"tdc_dropdown_texts")&&""!==d.tdc_dropdown_texts&&(a=!0);var c="",f="",h=Object.keys(d.value);if(_.has(d,
"tdc_min_options")&&h.length<=parseInt(d.tdc_min_options))return c;var l=' data-responsive="" ',k=String(tdcSidebarPanel._getParameterCurrentValue(d,b));try{var g=JSON.parse(window.atob(k));l=' data-responsive="'+k+'" ';"undefined"!==typeof g[tdcSidebar.currentViewportSettings.name]&&(k=g[tdcSidebar.currentViewportSettings.name])}catch(r){}for(g=0;g<h.length;g++){var n=!1,p="",q=h[g],t=String(d.value[h[g]]);_.isObject(d.value[h[g]])&&(n=!0,t=_.values(d.value[h[g]])[0],q=_.keys(d.value[h[g]])[0]);
if(e||a){0===g&&""===k&&(k=t);k===t&&(p=" checked ");var v=_.uniqueId(),u=t;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)u="col_"+u;f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(d,b)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+p+' value="'+t+'">';e?(p="",n&&(p="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+p+'" for="'+v+'" title="'+q+'"><div class="'+u+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+
v+'" title="'+q+'">'+t+"</label>"}else k===t&&(p=' selected="selected" '),f+="<option "+p+' value="'+t+'">'+q+"</option>"}h="";_.has(d,"description")&&""!==d.description&&(h=' title="'+d.description+'" ');c+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';c+='<div class="tdc-property-title"><span class="tdc-search-data"'+h+">"+d.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';c+=
'<div class="tdc-property">';e||a?c+=f:(c+="<select "+tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" '+l+h+">",c=c+f+"</select>");c=c+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return c+"</div>"},addCheckBox:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(a=" checked ");var c='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
...
var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var h="";_.has(d,"value")&&""!==d.value&&(h=d.value);var l="";""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&(l=tdcSidebarPanel._getParameterCurrentValue(d,b));var k='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';k+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";k=k+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+
'" type="range" data-value="'+l+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+l+'" />');k=k+('<input type="text" class="tdc_range_value" data-default_value="'+h+'" value="'+l+'"/></div><span class="tdc-param-name">')+(d.param_name+"</span>");return k+="</div>"},addRangeResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a="";_.has(d,"range_max")&&""!==d.range_max&&(a=d.range_max);
var c="";_.has(d,"range_min")&&""!==d.range_min&&(c=d.range_min);var f="";_.has(d,"range_step")&&""!==d.range_step&&(f=d.range_step);var h="";_.has(d,"value")&&""!==d.value&&(h=d.value);""!==tdcSidebarPanel._getParameterCurrentValue(d,b)&&tdcSidebarPanel._getParameterCurrentValue(d,b);var l="";_.has(d,"placeholder")&&""!==d.placeholder&&(l=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var k=' data-responsive="" ',g=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var n=
...
g+'" data-min="'+c+'" data-max="'+a+'" data-step="'+f+'" min="'+c+'" max="'+a+'" step="'+f+'" value="'+g+'" '+k+" />");n=n+('<input type="text" class="tdc_range_value" data-default_value="'+h+'" '+l+' value="'+g+'"/></div><span class="tdc-param-name">')+(d.param_name+"</span>");return n+="</div>"},addRangeMultiple:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",h="",l=[],k=
"",g="",n="",p="",q="",t="",v="",u;for(u in a)a.hasOwnProperty(u)&&(l.push(a[u].unit),""===g||""===k)&&(p=a[u].unit,g=' data-range_unit="'+p+'" ',n=a[u].value,k=' data-range_value="'+n+'" ',q=a[u].range_min,t=a[u].range_max,v=a[u].range_step);if(""!==c){for(var r=[],w=0;w<l.length&&!(r=c.split(l[w]),1<r.length);w++);r.length&&(p=l[w],g=' data-range_unit="'+p+'" ',n=r[0],k=' data-range_value="'+n+'" ')}for(u in a)a.hasOwnProperty(u)&&(c=_.uniqueId(),f+=" data-value_"+u+'="'+a[u].value+'" ',f+=" data-min_"+
u+'="'+a[u].range_min+'" ',f+=" data-max_"+u+'="'+a[u].range_max+'" ',f+=" data-step_"+u+'="'+a[u].range_step+'" ',l=a[u].value,r="",a[u].unit===p&&(l=n,q=a[u].range_min,t=a[u].range_max,v=a[u].range_step,r="checked"),h+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+u+'" data-unit_value="'+a[u].unit+'" type="radio" id="'+c+'" '+r+' data-default_value="'+a[u].value+'" data-last_value="'+l+'"/>',h+='<label for="'+c+'">'+a[u].unit+"</label>");a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+
'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+k+" "+g+" "+f+' min="'+q+'" max="'+t+'" step="'+v+'" value="'+n+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+h+'</div><input type="text" class="tdc_range_value" value="'+(n+'"/>');
a+="</div>";a+="</div>";a+='<span class="tdc-param-name">'+d.param_name+"</span>";return a+="</div>"},addRangeMultipleResponsive:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a=d.tdc_values,c=tdcSidebarPanel._getParameterCurrentValue(d,b),f="",h="",l=[],k=' data-responsive="" ',g="",n="",p="",q="",t="",v="",u="",r;for(r in a)a.hasOwnProperty(r)&&(l.push(a[r].unit),""===n||""===g)&&(q=a[r].unit,n=' data-range_unit="'+q+'" ',p=a[r].value,g=
...
r+'="'+a[r].value+'" ',f+=" data-min_"+r+'="'+a[r].range_min+'" ',f+=" data-max_"+r+'="'+a[r].range_max+'" ',f+=" data-step_"+r+'="'+a[r].range_step+'" ',w=a[r].value,c="",a[r].unit===q&&(w=p,t=a[r].range_min,v=a[r].range_max,u=a[r].range_step,c="checked"),h+='<input name="'+tdcSidebarPanel._getParameterDomName(d)+'_unit" data-unit="'+r+'" data-unit_value="'+a[r].unit+'" type="radio" id="'+l+'" '+c+' data-default_value="'+a[r].value+'" data-last_value="'+w+'"/>',h+='<label for="'+l+'">'+a[r].unit+
"</label>");a='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="range" '+g+" "+n+" "+f+" "+k+' min="'+t+'" max="'+v+'" step="'+u+'" value="'+p+'"/>');a=a+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+
h+'</div><input type="text" class="tdc_range_value" value="'+(p+'"/>');a+="</div>";a+="</div>";a+='<span class="tdc-param-name">'+d.param_name+"</span>";return a+="</div>"},addIconSelector:function(d,b){var e="";_.has(d,"description")&&""!==d.description&&(e=' title="'+d.description+'" ');var a='<div class="'+tdcSidebarPanel._getParameterClasses(d)+'">';a+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";a=a+'<div class="tdc-property"><div class="tdc-icon-wrap tdc-no-icon-selected" '+
...
d.description===c.text()?e=' title="'+d.description+'" ':a='<div class="tdc-description">'+d.description+"</div>"}c="";_.has(d,"placeholder")&&""!==d.placeholder&&(c=' data-placeholder="'+d.placeholder+'" placeholder="'+d.placeholder+'" ');var f=' data-responsive="" ',h=tdcSidebarPanel._getParameterCurrentValue(d,b);try{var l=JSON.parse(window.atob(h));f=' data-responsive="'+h+'" ';h="undefined"===typeof l[tdcSidebar.currentViewportSettings.name]?"":l[tdcSidebar.currentViewportSettings.name]}catch(k){}l=
'<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(d)+'">';l+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+d.heading+"</span></div>";l=l+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(d,b)+' name="'+tdcSidebarPanel._getParameterDomName(d)+'" type="text" value="'+h+'" '+c+f+e+"/>");l=l+a+'</div><span class="tdc-param-name">'+(d.param_name+"</span>");return l+="</div>"},addTextAreaHtml:function(d,b){_.has(d,"description");
...
tdcIFrameData.getModel(d.data("model_id"));var f=d.data("param_name"),h=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];a=[];for(var l=c="",k=0;k<h.params.length;k++)if(f===h.params[k].param_name){f=h.params[k].tdc_values;for(var g in f)f.hasOwnProperty(g)&&(a.push(f[g].unit),""===c||""===l)&&(c=f[g].value,l=f[g].unit);break}_.isUndefined(b)?(b=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),_.isUndefined(b)&&(d.data("range_value",c),d.data("range_unit",l),d.val(c),g=e.find('input[type="radio"][data-unit_value="'+
l+'"]'),k=g.data("unit"),f=d.data("min_"+k),l=d.data("max_"+k),k=d.data("step_"+k),h=d.get(0),g.prop("checked",!0),h.min=f,h.max=l,h.step=k,h.value=c,g.data("last_value",c),e.find('input[type="text"]').val(c)),"all"===tdcSidebar.currentViewportSettings.name?e.removeClass("tdc-css-inherited"):e.addClass("tdc-css-inherited")):e.removeClass("tdc-css-inherited");if(!_.isUndefined(b)){c=[];for(k=0;k<a.length&&!(c=b.split(a[k]),1<c.length);k++);c.length&&(c=c[0],l=a[k],d.data("range_value",c),d.data("range_unit",
l),d.val(c),g=e.find('input[type="radio"][data-unit_value="'+l+'"]'),k=g.data("unit"),f=d.data("min_"+k),l=d.data("max_"+k),k=d.data("step_"+k),h=d.get(0),g.prop("checked",!0),h.min=f,h.max=l,h.step=k,h.value=c,g.data("last_value",c),e.find('input[type="text"]').val(c))}}},showShortcodeFromPath:function(d){if(!_.isUndefined(d)){d=d.toString().split("_");var b;d.forEach(function(a,d){""!==a&&(_.isUndefined(b)?b=tdcIFrameData.tdcTopCollection.at(a):(d=b.get("childCollection"),!_.isUndefined(d)&&d.length>
a&&(b=d.at(a))))});if(!_.isUndefined(b)){var e=b.get("blockUid");if(!_.isUndefined(e)){var a=tdcAdminIFrameUI.getLiveIframe();d=a.contents().find("#"+e);d.length||(d=a.contents().find('[data-td-block-uid="'+e+'"]'));d.length&&(a.contents().scrollTop(d.offset().top-100),e={},tdcOperationUI.inZone(d)?tdcOperationUI.inRow(d)?tdcOperationUI.inColumn(d)?tdcOperationUI.inInnerRow(d)?tdcOperationUI.inInnerColumn(d)?(e.$currentZone=tdcOperationUI.inZone(d),e.$currentRow=tdcOperationUI.inRow(d),e.$currentColumn=
...
'"]').attr("selected",!0);tdcSidebar.$_buttonZone.click(function(){tdcSidebar.$_tdcZone.show();tdcWindowFrame.setWindowFrame(tdcSidebar.$_tdcZone)});tdcSidebar.$_tdcZone.on("click",".tdc-zone-icon",function(d){d=f(this).parent();var a=d.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");d.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===a?(tdcIFrameData.activateZone(a,!0,!0),d.addClass("tdc-zone-sticky-active"),d.removeClass("tdc-zone-sticky-inactive"),
"tdc_header_desktop_sticky"===a?d.hasClass("tdc-zone-sticky-active")?tdcState.setHeaderSticky():tdcState.unsetHeaderSticky():d.hasClass("tdc-zone-sticky-active")?tdcState.setMobileHeaderSticky():tdcState.unsetMobileHeaderSticky()):tdcIFrameData.activateZone(a,b,!0)}).on("click",".tdc-zone-sticky-info",function(d){d=f(this).parent();var a=d.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");d.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===
a?(d.hasClass("tdc-zone-sticky-inactive")?tdcIFrameData.activateZone(a,!0,!0):tdcIFrameData.activateZone(a,!1),d.toggleClass("tdc-zone-sticky-active"),d.toggleClass("tdc-zone-sticky-inactive"),"tdc_header_desktop_sticky"===a?d.hasClass("tdc-zone-sticky-active")?tdcState.setHeaderSticky():tdcState.unsetHeaderSticky():d.hasClass("tdc-zone-sticky-active")?tdcState.setMobileHeaderSticky():tdcState.unsetMobileHeaderSticky()):tdcIFrameData.activateZone(a,b,!0)}).on("change",".tdc-header-template-list",
...
c){a=f(c);c=a.data("button_class");a.hasClass("tdc-sidebar-modal-menu")?a.toggleClass("tdc-modal-open"):(a.removeClass("tdc-modal-open"),"undefined"!==typeof c&&""!==c&&(a=f("."+c),a.length&&a.removeClass("tdc-window-open")))})});tdcSidebar.$_sidebarSearch.keyup(function(b){var a=f(this);f(".tdc-sidebar-element").each(function(c,b){c=f(b);-1===c.find(".tdc-element-id").html().toLowerCase().indexOf(a.val().trim().toLowerCase())?c.hide():c.show()});f(".tdc-sidebar-separator").each(function(a,b){a=f(b);
a.nextUntil(".tdc-sidebar-separator").is(":visible")?a.show():a.hide()})});tdcSidebar.$_sidebar.on("mouseenter",function(){tdcSidebar.mouseOverSidebar=!0}).on("mouseleave",function(){tdcSidebar.mouseOverSidebar=!1});f("body").css("overflow","hidden");tdcSidebar._sidebarModal();tdcSidebar._liveInspectorTabs();tdcSidebar.updateSavedShortcodes();tdcSidebar.editTemplateName();tdcSidebarPanel.init()},hideWpeditor:function(){f("#tdc-wpeditor").hide()},setForcedHeaderZone:function(b){tdcSidebar._forcedHeaderZone=
...
break;default:tdcSidebar.$_editZone.show(),tdcSidebar.$_editRow.show(),tdcSidebar.$_editColumn.show(),k=tdcSidebar.getCurrentElement(),"vc_column_inner"===b.get("parentModel").get("tag")?(tdcSidebar.$_editInnerRow.show(),tdcSidebar.$_editInnerColumn.show()):(tdcSidebar.$_editInnerRow.hide(),tdcSidebar.$_editInnerColumn.hide())}tdcSidebar.$_currentElementHead.html(m);tdcSidebar.$_currentElementSiblings.html(h);tdcSidebar.$_sidebar.find(".tdc-responsiveness").addClass(a);tdcSidebar.$_currentElementHead.off().mouseenter(function(a){a.preventDefault();
k.trigger(a)}).mouseleave(function(a){a.preventDefault();k.trigger(a)}).mousedown(function(a){""!==h&&(tdcSidebar.$_currentElementSiblings.toggleClass("tdc-current-element-siblings-visible"),a=f(this),tdcSidebar.$_currentElementSiblings.hasClass("tdc-current-element-siblings-visible")?a.addClass("tdc-current-element-siblings-button-on"):a.removeClass("tdc-current-element-siblings-button-on"))});tdcSidebar.$_currentElementSiblings.find("li").off().click(function(a){a=f(this);var c=a.data("block_type"),
...
c,b){"success"===c&&d.isObject(a)&&(d.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(a.global_template?tdcState.setGlobalTemplate():tdcState.unsetGlobalTemplate(),a.no_header?(tdcState.setNoHeader(),tdcState.setHeaderTemplateId("no_header"),tdcState.setHeaderTemplateContent("")):(tdcState.unsetNoHeader(),tdcState.setHeaderTemplateId(a.template_id),tdcState.setHeaderTemplateContent(a.template_content)),tdcIFrameData.setHeaderTemplate(a.template_content)))}).fail(function(a,c,b){})},updateFooterTemplates:function(){tdcSidebar.$_footerTemplateList.find("option").each(function(b){b=
f(this);""!==b.val()&&"no_footer"!==b.val()&&b.remove()});f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_footer_templates","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{}}).done(function(b,a,c){f(".tdc-save-page").removeClass("tdc-saving-loader");"success"===a&&d.isObject(b)&&(d.has(b,"errors")?new tdcNotice.notice(b.errors,!0,!1):d.has(b,"tdb_footer_templates")&&b.tdb_footer_templates.forEach(function(a){var c=
"";if(""!==tdcState.getFooterTemplateId()&&"no_header"!==tdcState.getFooterTemplateId()&&parseInt(tdcState.getFooterTemplateId())===parseInt(a.id)||"no_footer"===tdcState.getFooterTemplateId()&&tdcState.getFooterTemplateId()===a.id)c="selected";a=f('<option value="tdb_template_'+a.id+'" '+c+">"+a.title+"</option>");tdcSidebar.$_footerTemplateList.append(a)}))}).fail(function(b,a,c){})},getFooterTemplate:function(b){f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_footer_template",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:{td_magic_token:tdcLivePanel.$token.val(),tdc_action:"get_footer_template",tdc_footer_template_id:b}}).done(function(a,c,b){"success"===c&&d.isObject(a)&&(d.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(a.global_template?tdcState.setGlobalFooterTemplate():tdcState.unsetGlobalFooterTemplate(),a.no_footer?(tdcState.setNoFooter(),tdcState.setFooterTemplateId("no_footer"),
tdcState.setFooterTemplateContent("")):(tdcState.unsetNoFooter(),tdcState.setFooterTemplateId(a.template_id),tdcState.setFooterTemplateContent(a.template_content)),tdcIFrameData.setFooterTemplate(a.template_content)))}).fail(function(a,c,b){})}};tdcSidebar.init()})(jQuery,_);var tdcSidebarController={};
...
f(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");f(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(b){var e=f("img",b).attr("src"),m="";"undefined"===typeof e?(e=f(b).attr("src"),m=f(b).attr("class")):m=f("img",b).attr("class");f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},
dataType:"json",data:{image_class:m,action:"tdc_ajax_get_image_id"}}).done(function(b,f,h){if("success"===f)if(d.isObject(b)&&d.has(b,"errors"))new tdcNotice.notice(b.errors,!0,!1);else{f=a.closest(".tdc-property-wrap");h=f.find(".tdc-css-image-remove");var m=f.find(".tdc-inherit-image");h.removeClass("tdc-hidden-button");"all"===tdcSidebar.currentViewportSettings.name?m.hide():m.show();a.attr("style","background-image: url( '"+e+"') ");a.data("image_link",e);a.data("image_id",b.image_id);window.send_to_editor=
...
100):tdcCssEditor._updateColorField(a)},_inheritSelect:function(e){e=f(e.currentTarget);var a=e.closest(".tdc-property-wrap"),c=a.data("tdc-for");d.isUndefined(tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][c])||delete tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][c];var m={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,b,m);var h=a.find("select:first");m.isInherited?(a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),e.hide()):(a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),
e.show());d.isUndefined(c)?(h.val(h.find("option:first").val()),e.hide()):h.val(c);tdcCssEditor._updateData(h)},_inheritColor:function(e){e=f(e.currentTarget);var a=e.closest(".tdc-property-wrap"),c=a.find("input"),m=a.find(".tdc-colorpicker-wrap"),h=a.data("tdc-for");d.isUndefined(tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][h])||delete tdcCssEditor._currentCssSettings[tdcSidebar.currentViewportSettings.name][h];c.data("no_value",0);var l={isInherited:!1};h=tdcCssEditor._getSettingsProperty(h,
b,l);l.isInherited?(a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),e.hide()):(a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),e.show());d.isUndefined(h)?(c.val(""),e.hide(),tdcCssEditor._updateData(c),tdcCssEditor._checkDefaultColor(c)):(c.val(""),c.attr("placeholder",h),m.attr("style","background-color: "+tdcCssEditor._getRgba(h)),tdcCssEditor._updateData(c))},_inheritImage:function(e){var a=f(e.currentTarget);e=a.closest(".tdc-property-wrap");var c=e.find(".tdc-css-image-wrap"),m=e.find(".tdc-css-image-remove");
...
c=a.val();var h=1;a.hasClass("tdc-css-opacity")&&(h=.01);var l=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:f.isNumeric(c)&&(l=parseFloat(c)+h);break;case 40:f.isNumeric(c)&&(l=parseFloat(c)-h)}break;case "mousewheel":b.preventDefault(),b.stopImmediatePropagation(),f.isNumeric(c)&&(l=0<b.originalEvent.deltaY?parseFloat(c)-h:parseFloat(c)+h)}d.isNaN(l)||(1>h&&(l=l.toFixed(2)),a.val(l));tdcCssEditor._updateData(a);c=e.data("tdc-for");b={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,
...
a+'"></div>'),f("body").append(c),c.find("input").on("input",function(a){var b=f(this),e=tdcAdminIFrameUI.getLiveIframe(),m=b.data("scroll-bar-width");c.find("output").html(b.val());tdcCssEditor.timeoutMediaInterval=setTimeout(function(){d.isUndefined(tdcCssEditor.timeoutMediaInterval)||clearTimeout(tdcCssEditor.timeoutMediaInterval);e.css("width",parseInt(b.val())+parseInt(m))},200)}));""===b?c.hide():(c.show(),tdcCssEditor.timeoutIframeHtml=setTimeout(function(){d.isUndefined(tdcCssEditor.timeoutIframeHtml)||
...
e){a=f(e);e=a.closest(".tdc-property-wrap");var c=e.find(".tdc-css-image-remove"),m=e.find(".tdc-inherit-image"),k={isInherited:!1},g=tdcCssEditor._getSettingsProperty("background-image",b,k);k.isInherited?e.addClass(tdcCssEditor._INHERITED_CSS_CLASS):e.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);d.isUndefined(g)?(c.addClass("tdc-hidden-button"),m.hide()):("no_value"===g?c.addClass("tdc-hidden-button"):(c.removeClass("tdc-hidden-button"),a.attr("style",'background-image: url("'+g+'")')),"all"!==
tdcSidebar.currentViewportSettings.name&&m.show());a.data("image_link",g)});f(".tdc-inherit").each(function(a,e){a=f(e);e=a.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||e.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))a.hide();else{var c=e.data("tdc-for");e={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,b,e);e.isInherited?a.hide():d.isUndefined(c)||a.show()}})});return tdcCssEditor.generateEditorResponsiveContent()},_cleanCss:function(e,a){if("undefined"===
...
a+'"':""}function c(){return k.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function m(a,b){b=tdcCssEditor._getSettingsProperty(a,b,e());var f="-",m="";k.isInherited&&(f=b,b="");d.isUndefined(l)||"margin-left"!==a&&"margin-right"!==a||(m=l.get("tag"),m="vc_column"===m||"vc_column_inner"===m?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+a+'" name="" type="text" value="'+b+'" class="tdc-css-box-input tdc-css-box-input-'+a+c()+m+'" title="Css '+a+'" placeholder="'+f+
'" '+tdcSidebarPanel._getParamterDataAtts(h,l)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var h=tdcCssEditor._mappedParameter,l=tdcCssEditor._model,k={isInherited:!1};var g='<div class="tdc-responsiveness"><div class="'+(tdcSidebarPanel._getParameterClasses(h)+'">');g=g+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+m("margin-top","");g+=m("margin-right","");g+=m("margin-bottom","");g+=m("margin-left","");g=g+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+
m("border-top-width","");g+=m("border-right-width","");g+=m("border-bottom-width","");g+=m("border-left-width","");g=g+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+m("padding-top","");g+=m("padding-right","");g+=m("padding-bottom","");g+=m("padding-left","");g+="</div></div></div></div>";var n=tdcCssEditor._getSettingsProperty("border-style",b,e());g+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+c()+'" data-tdc-for="border-style">';g=g+'<div class="tdc-property-title"><span title="Css border-style" class="tdc-search-data">Border style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-border-style" '+
...
n);g+="</select></div></div>";n=d.uniqueId();var p=tdcCssEditor._getSettingsProperty("border-color","",e()),q="";k.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+c()+'" data-tdc-for="border-color">';g=g+'<div class="tdc-property-title"><span title="Css border-color" class="tdc-search-data">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("border-radius","",e());p="";k.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+c()+'" data-tdc-for="border-radius">';g=g+'<div class="tdc-property-title"><span title="Css border-radius" class="tdc-search-data">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("width","",e());p="";k.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+c()+'" data-tdc-for="width">';g=g+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("shadow-size","",e());p="";k.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-size">';g=g+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("shadow-color","",e());q="";k.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+c()+'" data-tdc-for="shadow-color">';g=g+'<div class="tdc-property-title"><span title="Css shadow-color" class="tdc-search-data">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-h","",e());p="";k.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-h">';g=g+'<div class="tdc-property-title"><span title="Css shadow-offset-h" class="tdc-search-data">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("shadow-offset-v","",e());p="";k.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+c()+'" data-tdc-for="shadow-offset-v">';g=g+'<div class="tdc-property-title"><span title="Css shadow-offset-v" class="tdc-search-data">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("background-color","",e());q="";k.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+c()+'" data-tdc-for="background-color">';g=g+'<div class="tdc-property-title"><span title="Css background-color" class="tdc-search-data">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",b,e());g+='<div class="tdc-property-wrap tdc-property-attach_image'+c()+'">';g=g+'<div class="tdc-property-title"><span title="Css background-image" class="tdc-search-data">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property"><div class="tdc-css-bg-image tdc-css-image-wrap " '+
...
"</select></div></div>";n=tdcCssEditor._getSettingsProperty("opacity","",e());p="";k.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="opacity">';g=g+'<div class="tdc-property-title"><span title="Css background-image opacity" class="tdc-search-data">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-1-overlay","",e());q="";k.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+c()+'" data-tdc-for="color-1-overlay">';g=g+'<div class="tdc-property-title"><span title="Css gradient color From" class="tdc-search-data">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=d.uniqueId();p=tdcCssEditor._getSettingsProperty("color-2-overlay","",e());q="";k.isInherited&&(q=p,p="");g+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+c()+'" data-tdc-for="color-2-overlay">';g=g+'<div class="tdc-property-title"><span  title="Css gradient color To" class="tdc-search-data">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(h,l)+tdcCssEditor._getDataNoValue(p)+' id="'+n+'" name="" type="text" '+a(q)+' value="'+p+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsProperty("gradient-direction","",e());p="";k.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="gradient-direction">';g=g+'<div class="tdc-property-title"><span title="Css gradient direction" class="tdc-search-data">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';n=tdcCssEditor._getSettingsProperty("content-h-align",b,e());g+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="content-h-align">';g=g+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="">');g+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],n);g+="</select></div></div>";n=tdcCssEditor._getSettingsProperty("z-index","",e());p="";k.isInherited&&(p=n,n="");g+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="z-index">';g=g+'<div class="tdc-property-title"><span title="Z-index" class="tdc-search-data">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+
(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');g+="</div></div>";n=tdcCssEditor._getSettingsPropertyFromCssSettings("display",b);g+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+c()+'" data-tdc-for="display">';g=g+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+(tdcSidebarPanel._getParamterDataAtts(h,l)+' name="">');
...
l=!1,k=0,g=0;g<b.length;g++)d.isUndefined(c)||c!==b[g].value||(k=g),f="",d.isUndefined(a)||a!==b[g].value||(f='selected="selected"',l=!0),e.push("<option "+f+' value="'+b[g].value+'">'+b[g].display+"</option>");l||(e[k]='<option selected="selected" value="'+b[k].value+'">'+b[k].display+"</option>");return e.join("")},_generateCssAttValue:function(b){var a={},c=b.find(".tdc-css-box-input-margin-top").val().trim(),e=b.find(".tdc-css-box-input-margin-right").val().trim(),f=b.find(".tdc-css-box-input-margin-bottom").val().trim(),
l=b.find(".tdc-css-box-input-margin-left").val().trim(),k=b.find(".tdc-css-box-input-border-top-width").val().trim(),g=b.find(".tdc-css-box-input-border-right-width").val().trim(),n=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),t=b.find(".tdc-css-box-input-padding-right").val().trim(),v=b.find(".tdc-css-box-input-padding-bottom").val().trim(),u=b.find(".tdc-css-box-input-padding-left").val().trim(),
...
k);""!==g&&(a["border-right-width"]=g);""!==n&&(a["border-bottom-width"]=n);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==t&&(a["padding-right"]=t);""!==v&&(a["padding-bottom"]=v);""!==u&&(a["padding-left"]=u);c=b.find(".tdc-css-border-style");e=c.val().trim();""===e||c.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=e);c=b.find(".tdc-css-border-color");e=c.val().trim();""!==e?a["border-color"]=e:(c=c.data("no_value"),d.isUndefined(c)||
...
change:function(c,d){c=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",c);b.val(c).trigger("change");a.triggerSelection?a.setColor(c,!0):a.setColor(c)},create:function(){var c=b.data("a8cIris"),l=b.closest(".wp-picker-container"),k=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(l.find(".wp-picker-holder")),g=k.find(".cs-alpha-slider"),
...
n.text(1>a?a:"")},create:function(){var d=parseFloat(m.alpha/100);n.text(1>d?d:"");p.css("background-color",m.value);l.on("click",".wp-picker-clear",function(){c._color._alpha=1;n.text("");g.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,!0):a.setColor(e)});l.on("click",".wp-picker-default",function(){var a=f.cs_ParseColorValue(b.data("default-color")),d=parseFloat(a.alpha/100);c._color._alpha=d;n.text(1>d?d:"");g.slider("option","value",a.alpha).trigger("slide")});
...
".tdc-gradient-result",function(b){var c=a.$container.find(".tdc-gradient-result-percentage"),d=a.$container.find(".tdc-gradient-result"),e=d.find(".tdc-gradient-right-color"),f=d.find(".tdc-gradient-current-mix");if(f.length){var h=0;"undefined"!==typeof a.eventOffsetX&&(h=a.eventOffsetX);b=b.pageX-d.offset().left-f.width()/2-h;h=100*b/(d.width()-f.outerWidth(!0));0>h?b=h=0:100<h&&(h=100,b=d.width()-e.outerWidth(!0));c.html(Math.round(h)+"%");f.css("left",b);f.data("percentage",Math.round(100-h));
...
f.cs_ParseColorValue(b.val());b.tdPaletteColorPicker({clear:function(){b.trigger("keyup")},change:function(c,d){c=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",c);b.val(c).trigger("change");a.triggerSelection?a.setColor(c,!0):a.setColor(c)},create:function(){var c=b.data("a8cIris"),l=b.closest(".wp-picker-container"),k=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(l.find(".wp-picker-holder")),
g=k.find(".cs-alpha-slider"),n=k.find(".cs-alpha-text"),p=k.find(".cs-alpha-slider-offset"),q=f('<div class="tdc-color-values"></div>').appendTo(l.find(".wp-picker-holder"));a.$container=l;if("undefined"!==typeof d.tdcAdminSettings.tdcSavings.recentColors&&d.tdcAdminSettings.tdcSavings.recentColors.length)for(var t=d.tdcAdminSettings.tdcSavings.recentColors.length-1;0<=t;t--){var v=d.tdcAdminSettings.tdcSavings.recentColors[t];try{var u=JSON.parse(d.atob(v));"undefined"!==typeof u&&f('<div class="tdc-color-value" style="background-color: '+
u+'" data-color="'+u+'"><div class="tdc-color-value-delete"></div></div>').appendTo(q)}catch(r){}}g.slider({slide:function(a,d){a=parseFloat(d.value/100);c._color._alpha=a;b.tdPaletteColorPicker("color",c._color.toString());n.text(1>a?a:"")},create:function(){var d=parseFloat(m.alpha/100);n.text(1>d?d:"");p.css("background-color",m.value);l.on("click",".wp-picker-clear",function(){c._color._alpha=1;n.text("");g.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(e,!0):a.setColor(e)});
