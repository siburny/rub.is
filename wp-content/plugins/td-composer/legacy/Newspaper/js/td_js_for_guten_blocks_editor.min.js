...
null),el("hr",null),el(RangeControl,{label:"Custom Top Margin (px)",allowReset:!0,value:b.attributes.tdMarginTop,onChange:function(a){b.setAttributes({tdMarginTop:a})},min:-500,max:500}),el(RangeControl,{label:"Custom Bottom Margin (px)",allowReset:!0,value:b.attributes.tdMarginBottom,onChange:function(a){b.setAttributes({tdMarginBottom:a})},min:-500,max:500}),el(RangeControl,{label:"Custom Maximum Width (px)",allowReset:!0,value:b.attributes.tdMaxWidth,onChange:function(a){b.setAttributes({tdMaxWidth:a})},
min:100,max:2E3}))))}},"tdThemeBlocksControls");wp.hooks.addFilter("editor.BlockEdit","td/core-blocks-controls",tdThemeBlocksControls);
