...
var tdBlockWithCustomEditorWrapper=wp.compose.createHigherOrderComponent(function(c){console.log("12");return function(b){var a=b.name,d=b.attributes,e={};"core/image"===a&&(e.className=(""!==d.tdCaptionAlign?"td-caption-align-"+d.tdCaptionAlign:"")+" "+(""!==d.tdImgStyle?"td-img-"+d.tdImgStyle:""));"core/quote"===a&&(e.className=""!==d.quoteStyle?d.quoteStyle:"");"core/paragraph"===a&&(e.className=""!==d.dropCapStyle?d.dropCapStyle:"");"core/list"===a&&(e.className=d.tdArrowListStyle?"td-arrow-list":
"");"core/button"===a&&(e.className=""!==d.tdButtonSize?"td_btn_"+d.tdButtonSize:"");if(td_core_blocks_with_custom_spacing.includes(a)){a=b.wrapperProps;var f={};"undefined"!==typeof d.align&&"wide"===d.align?"undefined"!==typeof d.tdMaxWidth&&(f.maxWidth="none",f.width=d.tdMaxWidth+"px"):"undefined"!==typeof d.tdMaxWidth&&(f.maxWidth=d.tdMaxWidth+"px");"undefined"!==typeof d.tdMarginTop&&(f.marginTop=d.tdMarginTop+"px");"undefined"!==typeof d.tdMarginBottom&&(f.marginBottom=d.tdMarginBottom+"px");
a=lodash.assign(a,{style:f});e.wrapperProps=a}b=lodash.assign(b,e);return el(c,b)}});wp.hooks.addFilter("editor.BlockListBlock","td/blocks-with-custom-edit-wrapper",tdBlockWithCustomEditorWrapper);
